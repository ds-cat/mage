 ...
 * @author TheElk801
 */
public final class ADifficultChoice extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ADifficultChoice(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ADifficultChoice(final ADifficultChoice card) {
        super(card);
    }

    @Override
    public ADifficultChoice copy() {
        return new ADifficultChoice(this);
    }
}
