 ...
 * @author TheElk801
 */
public final class ALongJourneyHome extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ALongJourneyHome(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ALongJourneyHome(final ALongJourneyHome card) {
        super(card);
    }

    @Override
    public ALongJourneyHome copy() {
        return new ALongJourneyHome(this);
    }
}
