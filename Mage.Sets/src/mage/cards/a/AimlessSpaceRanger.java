 ...
 * @author TheElk801
 */
public final class AimlessSpaceRanger extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public AimlessSpaceRanger(UUID ownerId, CardSetInfo setInfo) {
    ...
    private AimlessSpaceRanger(final AimlessSpaceRanger card) {
        super(card);
    }

    @Override
    public AimlessSpaceRanger copy() {
        return new AimlessSpaceRanger(this);
    }
}
