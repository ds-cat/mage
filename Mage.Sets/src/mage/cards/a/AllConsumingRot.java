 ...
 * @author TheElk801
 */
public final class AllConsumingRot extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public AllConsumingRot(UUID ownerId, CardSetInfo setInfo) {
    ...
    private AllConsumingRot(final AllConsumingRot card) {
        super(card);
    }

    @Override
    public AllConsumingRot copy() {
        return new AllConsumingRot(this);
    }
}
