 ...
 * @author TheElk801
 */
public final class Altruism extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Altruism(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Altruism(final Altruism card) {
        super(card);
    }

    @Override
    public Altruism copy() {
        return new Altruism(this);
    }
}
