 ...
 * @author TheElk801
 */
public final class Ambition extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Ambition(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Ambition(final Ambition card) {
        super(card);
    }

    @Override
    public Ambition copy() {
        return new Ambition(this);
    }
}
