 ...
 * @author TheElk801
 */
public final class AndyHandDespoiler extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public AndyHandDespoiler(UUID ownerId, CardSetInfo setInfo) {
    ...
    private AndyHandDespoiler(final AndyHandDespoiler card) {
        super(card);
    }

    @Override
    public AndyHandDespoiler copy() {
        return new AndyHandDespoiler(this);
    }
}
