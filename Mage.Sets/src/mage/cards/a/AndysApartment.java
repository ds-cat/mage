 ...
 * @author TheElk801
 */
public final class AndysApartment extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public AndysApartment(UUID ownerId, CardSetInfo setInfo) {
    ...
    private AndysApartment(final AndysApartment card) {
        super(card);
    }

    @Override
    public AndysApartment copy() {
        return new AndysApartment(this);
    }
}
