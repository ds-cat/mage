 ...
 * @author TheElk801
 */
public final class AndysChosen extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public AndysChosen(UUID ownerId, CardSetInfo setInfo) {
    ...
    private AndysChosen(final AndysChosen card) {
        super(card);
    }

    @Override
    public AndysChosen copy() {
        return new AndysChosen(this);
    }
}
