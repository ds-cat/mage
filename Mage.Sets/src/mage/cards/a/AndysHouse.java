 ...
 * @author TheElk801
 */
public final class AndysHouse extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public AndysHouse(UUID ownerId, CardSetInfo setInfo) {
    ...
    private AndysHouse(final AndysHouse card) {
        super(card);
    }

    @Override
    public AndysHouse copy() {
        return new AndysHouse(this);
    }
}
