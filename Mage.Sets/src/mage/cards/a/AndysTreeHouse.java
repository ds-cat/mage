 ...
 * @author TheElk801
 */
public final class AndysTreeHouse extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public AndysTreeHouse(UUID ownerId, CardSetInfo setInfo) {
    ...
    private AndysTreeHouse(final AndysTreeHouse card) {
        super(card);
    }

    @Override
    public AndysTreeHouse copy() {
        return new AndysTreeHouse(this);
    }
}
