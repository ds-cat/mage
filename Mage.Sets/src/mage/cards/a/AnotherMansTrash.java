 ...
 * @author TheElk801
 */
public final class AnotherMansTrash extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public AnotherMansTrash(UUID ownerId, CardSetInfo setInfo) {
    ...
    private AnotherMansTrash(final AnotherMansTrash card) {
        super(card);
    }

    @Override
    public AnotherMansTrash copy() {
        return new AnotherMansTrash(this);
    }
}
