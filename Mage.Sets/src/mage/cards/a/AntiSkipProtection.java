 ...
 * @author TheElk801
 */
public final class AntiSkipProtection extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public AntiSkipProtection(UUID ownerId, CardSetInfo setInfo) {
    ...
    private AntiSkipProtection(final AntiSkipProtection card) {
        super(card);
    }

    @Override
    public AntiSkipProtection copy() {
        return new AntiSkipProtection(this);
    }
}
