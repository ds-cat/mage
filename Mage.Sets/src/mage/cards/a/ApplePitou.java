 ...
 * @author TheElk801
 */
public final class ApplePitou extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ApplePitou(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ApplePitou(final ApplePitou card) {
        super(card);
    }

    @Override
    public ApplePitou copy() {
        return new ApplePitou(this);
    }
}
