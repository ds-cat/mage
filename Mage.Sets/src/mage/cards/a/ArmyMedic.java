 ...
 * @author TheElk801
 */
public final class ArmyMedic extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ArmyMedic(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ArmyMedic(final ArmyMedic card) {
        super(card);
    }

    @Override
    public ArmyMedic copy() {
        return new ArmyMedic(this);
    }
}
