 ...
 * @author TheElk801
 */
public final class BarrelOfMonkeys extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BarrelOfMonkeys(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BarrelOfMonkeys(final BarrelOfMonkeys card) {
        super(card);
    }

    @Override
    public BarrelOfMonkeys copy() {
        return new BarrelOfMonkeys(this);
    }
}
