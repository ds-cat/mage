 ...
 * @author TheElk801
 */
public final class BeckoningCall extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BeckoningCall(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BeckoningCall(final BeckoningCall card) {
        super(card);
    }

    @Override
    public BeckoningCall copy() {
        return new BeckoningCall(this);
    }
}
