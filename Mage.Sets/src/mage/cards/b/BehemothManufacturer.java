 ...
 * @author TheElk801
 */
public final class BehemothManufacturer extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BehemothManufacturer(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BehemothManufacturer(final BehemothManufacturer card) {
        super(card);
    }

    @Override
    public BehemothManufacturer copy() {
        return new BehemothManufacturer(this);
    }
}
