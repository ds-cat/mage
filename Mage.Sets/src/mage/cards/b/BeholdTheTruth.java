 ...
 * @author TheElk801
 */
public final class BeholdTheTruth extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BeholdTheTruth(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BeholdTheTruth(final BeholdTheTruth card) {
        super(card);
    }

    @Override
    public BeholdTheTruth copy() {
        return new BeholdTheTruth(this);
    }
}
