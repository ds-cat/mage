 ...
 * @author TheElk801
 */
public final class BigIdeas extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BigIdeas(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BigIdeas(final BigIdeas card) {
        super(card);
    }

    @Override
    public BigIdeas copy() {
        return new BigIdeas(this);
    }
}
