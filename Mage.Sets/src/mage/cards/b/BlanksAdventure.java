 ...
 * @author TheElk801
 */
public final class BlanksAdventure extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BlanksAdventure(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BlanksAdventure(final BlanksAdventure card) {
        super(card);
    }

    @Override
    public BlanksAdventure copy() {
        return new BlanksAdventure(this);
    }
}
