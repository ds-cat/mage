 ...
 * @author TheElk801
 */
public final class BlazingDesire extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BlazingDesire(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BlazingDesire(final BlazingDesire card) {
        super(card);
    }

    @Override
    public BlazingDesire copy() {
        return new BlazingDesire(this);
    }
}
