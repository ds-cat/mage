 ...
 * @author TheElk801
 */
public final class BogBaseHenchgoon extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BogBaseHenchgoon(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BogBaseHenchgoon(final BogBaseHenchgoon card) {
        super(card);
    }

    @Override
    public BogBaseHenchgoon copy() {
        return new BogBaseHenchgoon(this);
    }
}
