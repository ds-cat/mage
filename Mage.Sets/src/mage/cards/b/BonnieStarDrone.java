 ...
 * @author TheElk801
 */
public final class BonnieStarDrone extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BonnieStarDrone(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BonnieStarDrone(final BonnieStarDrone card) {
        super(card);
    }

    @Override
    public BonnieStarDrone copy() {
        return new BonnieStarDrone(this);
    }
}
