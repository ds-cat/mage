 ...
 * @author TheElk801
 */
public final class BonnieStarEmpress extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BonnieStarEmpress(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BonnieStarEmpress(final BonnieStarEmpress card) {
        super(card);
    }

    @Override
    public BonnieStarEmpress copy() {
        return new BonnieStarEmpress(this);
    }
}
