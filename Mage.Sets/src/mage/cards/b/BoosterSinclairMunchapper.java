 ...
 * @author TheElk801
 */
public final class BoosterSinclairMunchapper extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BoosterSinclairMunchapper(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BoosterSinclairMunchapper(final BoosterSinclairMunchapper card) {
        super(card);
    }

    @Override
    public BoosterSinclairMunchapper copy() {
        return new BoosterSinclairMunchapper(this);
    }
}
