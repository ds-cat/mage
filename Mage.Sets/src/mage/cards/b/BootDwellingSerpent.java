 ...
 * @author TheElk801
 */
public final class BootDwellingSerpent extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BootDwellingSerpent(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BootDwellingSerpent(final BootDwellingSerpent card) {
        super(card);
    }

    @Override
    public BootDwellingSerpent copy() {
        return new BootDwellingSerpent(this);
    }
}
