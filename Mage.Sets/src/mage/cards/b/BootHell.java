 ...
 * @author TheElk801
 */
public final class BootHell extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BootHell(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BootHell(final BootHell card) {
        super(card);
    }

    @Override
    public BootHell copy() {
        return new BootHell(this);
    }
}
