 ...
 * @author TheElk801
 */
public final class BootHellShowdown extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BootHellShowdown(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BootHellShowdown(final BootHellShowdown card) {
        super(card);
    }

    @Override
    public BootHellShowdown copy() {
        return new BootHellShowdown(this);
    }
}
