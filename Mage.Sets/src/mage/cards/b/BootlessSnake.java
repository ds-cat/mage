 ...
 * @author TheElk801
 */
public final class BootlessSnake extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BootlessSnake(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BootlessSnake(final BootlessSnake card) {
        super(card);
    }

    @Override
    public BootlessSnake copy() {
        return new BootlessSnake(this);
    }
}
