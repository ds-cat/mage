 ...
 * @author TheElk801
 */
public final class BoybuilderSkateboard extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BoybuilderSkateboard(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BoybuilderSkateboard(final BoybuilderSkateboard card) {
        super(card);
    }

    @Override
    public BoybuilderSkateboard copy() {
        return new BoybuilderSkateboard(this);
    }
}
