 ...
 * @author TheElk801
 */
public final class BrewingStorm extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BrewingStorm(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BrewingStorm(final BrewingStorm card) {
        super(card);
    }

    @Override
    public BrewingStorm copy() {
        return new BrewingStorm(this);
    }
}
