 ...
 * @author TheElk801
 */
public final class BrotherCalm extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BrotherCalm(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BrotherCalm(final BrotherCalm card) {
        super(card);
    }

    @Override
    public BrotherCalm copy() {
        return new BrotherCalm(this);
    }
}
