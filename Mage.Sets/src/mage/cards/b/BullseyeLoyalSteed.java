 ...
 * @author TheElk801
 */
public final class BullseyeLoyalSteed extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BullseyeLoyalSteed(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BullseyeLoyalSteed(final BullseyeLoyalSteed card) {
        super(card);
    }

    @Override
    public BullseyeLoyalSteed copy() {
        return new BullseyeLoyalSteed(this);
    }
}
