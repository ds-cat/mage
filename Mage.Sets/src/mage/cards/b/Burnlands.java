 ...
 * @author TheElk801
 */
public final class Burnlands extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Burnlands(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Burnlands(final Burnlands card) {
        super(card);
    }

    @Override
    public Burnlands copy() {
        return new Burnlands(this);
    }
}
