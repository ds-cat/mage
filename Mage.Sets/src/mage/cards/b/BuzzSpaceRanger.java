 ...
 * @author TheElk801
 */
public final class BuzzSpaceRanger extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public BuzzSpaceRanger(UUID ownerId, CardSetInfo setInfo) {
    ...
    private BuzzSpaceRanger(final BuzzSpaceRanger card) {
        super(card);
    }

    @Override
    public BuzzSpaceRanger copy() {
        return new BuzzSpaceRanger(this);
    }
}
