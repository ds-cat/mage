 ...
 * @author TheElk801
 */
public final class CashMoney extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CashMoney(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CashMoney(final CashMoney card) {
        super(card);
    }

    @Override
    public CashMoney copy() {
        return new CashMoney(this);
    }
}
