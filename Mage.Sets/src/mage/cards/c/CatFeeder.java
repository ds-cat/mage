 ...
 * @author TheElk801
 */
public final class CatFeeder extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CatFeeder(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CatFeeder(final CatFeeder card) {
        super(card);
    }

    @Override
    public CatFeeder copy() {
        return new CatFeeder(this);
    }
}
