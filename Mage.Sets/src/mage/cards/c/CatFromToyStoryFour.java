 ...
 * @author TheElk801
 */
public final class CatFromToyStoryFour extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CatFromToyStoryFour(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CatFromToyStoryFour(final CatFromToyStoryFour card) {
        super(card);
    }

    @Override
    public CatFromToyStoryFour copy() {
        return new CatFromToyStoryFour(this);
    }
}
