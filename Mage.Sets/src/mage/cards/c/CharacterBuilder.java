 ...
 * @author TheElk801
 */
public final class CharacterBuilder extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CharacterBuilder(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CharacterBuilder(final CharacterBuilder card) {
        super(card);
    }

    @Override
    public CharacterBuilder copy() {
