 ...
 * @author TheElk801
 */
public final class CharredSoldier extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CharredSoldier(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CharredSoldier(final CharredSoldier card) {
        super(card);
    }

    @Override
    public CharredSoldier copy() {
        return new CharredSoldier(this);
    }
}
