 ...
 * @author TheElk801
 */
public final class ChaseClassTraitor extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ChaseClassTraitor(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ChaseClassTraitor(final ChaseClassTraitor card) {
        super(card);
    }

    @Override
    public ChaseClassTraitor copy() {
        return new ChaseClassTraitor(this);
    }
}
