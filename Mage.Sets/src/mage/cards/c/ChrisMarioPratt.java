 ...
 * @author TheElk801
 */
public final class ChrisMarioPratt extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ChrisMarioPratt(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ChrisMarioPratt(final ChrisMarioPratt card) {
        super(card);
    }

    @Override
    public ChrisMarioPratt copy() {
        return new ChrisMarioPratt(this);
    }
}
