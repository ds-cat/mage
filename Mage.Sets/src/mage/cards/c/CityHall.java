 ...
 * @author TheElk801
 */
public final class CityHall extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CityHall(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CityHall(final CityHall card) {
        super(card);
    }

    @Override
    public CityHall copy() {
        return new CityHall(this);
    }
}
