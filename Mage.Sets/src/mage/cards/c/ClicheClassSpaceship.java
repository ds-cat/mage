 ...
 * @author TheElk801
 */
public final class ClicheClassSpaceship extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ClicheClassSpaceship(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ClicheClassSpaceship(final ClicheClassSpaceship card) {
        super(card);
    }

    @Override
    public ClicheClassSpaceship copy() {
        return new ClicheClassSpaceship(this);
    }
}
