 ...
 * @author TheElk801
 */
public final class ClockworkConductor extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ClockworkConductor(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ClockworkConductor(final ClockworkConductor card) {
        super(card);
    }

    @Override
    public ClockworkConductor copy() {
        return new ClockworkConductor(this);
    }
}
