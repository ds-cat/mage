 ...
 * @author TheElk801
 */
public final class CloudJudgement extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CloudJudgement(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CloudJudgement(final CloudJudgement card) {
        super(card);
    }

    @Override
    public CloudJudgement copy() {
        return new CloudJudgement(this);
    }
}
