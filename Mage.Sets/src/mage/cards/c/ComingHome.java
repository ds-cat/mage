 ...
 * @author TheElk801
 */
public final class ComingHome extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ComingHome(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ComingHome(final ComingHome card) {
        super(card);
    }

    @Override
    public ComingHome copy() {
        return new ComingHome(this);
    }
}
