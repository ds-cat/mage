 ...
 * @author TheElk801
 */
public final class CowboyBoots extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CowboyBoots(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CowboyBoots(final CowboyBoots card) {
        super(card);
    }

    @Override
    public CowboyBoots copy() {
        return new CowboyBoots(this);
    }
}
