 ...
 * @author TheElk801
 */
public final class CowboyHat extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CowboyHat(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CowboyHat(final CowboyHat card) {
        super(card);
    }

    @Override
    public CowboyHat copy() {
        return new CowboyHat(this);
    }
}
