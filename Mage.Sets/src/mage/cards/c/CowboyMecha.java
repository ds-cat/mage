 ...
 * @author DsCat
 */
public final class CowboyMecha extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CowboyMecha(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CowboyMecha(final CowboyMecha card) {
        super(card);
    }

    @Override
    public CowboyMecha copy() {
        return new CowboyMecha(this);
    }
}
