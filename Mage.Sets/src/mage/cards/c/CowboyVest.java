 ...
 * @author TheElk801
 */
public final class CowboyVest extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CowboyVest(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CowboyVest(final CowboyVest card) {
        super(card);
    }

    @Override
    public CowboyVest copy() {
        return new CowboyVest(this);
    }
}
