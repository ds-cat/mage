 ...
 * @author TheElk801
 */
public final class CreativeBlitz extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CreativeBlitz(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CreativeBlitz(final CreativeBlitz card) {
        super(card);
    }

    @Override
    public CreativeBlitz copy() {
        return new CreativeBlitz(this);
    }
}
