 ...
 * @author TheElk801
 */
public final class CreativelyBankrupt extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CreativelyBankrupt(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CreativelyBankrupt(final CreativelyBankrupt card) {
        super(card);
    }

    @Override
    public CreativelyBankrupt copy() {
        return new CreativelyBankrupt(this);
    }
}
