 ...
 * @author TheElk801
 */
public final class CrunchTime extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CrunchTime(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CrunchTime(final CrunchTime card) {
        super(card);
    }

    @Override
    public CrunchTime copy() {
        return new CrunchTime(this);
    }
}
