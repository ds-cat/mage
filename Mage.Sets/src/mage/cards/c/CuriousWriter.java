 ...
 * @author DsCat
 */
public final class CuriousWriter extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CuriousWriter(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CuriousWriter(final CuriousWriter card) {
        super(card);
    }

    @Override
    public CuriousWriter copy() {
        return new CuriousWriter(this);
    }
}
