 ...
 * @author DsCat
 */
public final class CymbolMonkey extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public CymbolMonkey(UUID ownerId, CardSetInfo setInfo) {
    ...
    private CymbolMonkey(final CymbolMonkey card) {
        super(card);
    }

    @Override
    public CymbolMonkey copy() {
        return new CymbolMonkey(this);
    }
}
