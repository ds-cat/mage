 ...
 * @author TheElk801
 */
public final class DaycareRescuer extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DaycareRescuer(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DaycareRescuer(final DaycareRescuer card) {
        super(card);
    }

    @Override
    public DaycareRescuer copy() {
        return new DaycareRescuer(this);
    }
}
