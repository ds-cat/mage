 ...
 * @author TheElk801
 */
public final class DeadGrowths extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DeadGrowths(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DeadGrowths(final DeadGrowths card) {
        super(card);
    }

    @Override
    public DeadGrowths copy() {
        return new DeadGrowths(this);
    }
}
