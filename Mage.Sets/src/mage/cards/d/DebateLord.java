 ...
 * @author TheElk801
 */
public final class DebateLord extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DebateLord(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DebateLord(final DebateLord card) {
        super(card);
    }

    @Override
    public DebateLord copy() {
        return new DebateLord(this);
    }
}
