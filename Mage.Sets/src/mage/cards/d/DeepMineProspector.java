 ...
 * @author TheElk801
 */
public final class DeepMineProspector extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DeepMineProspector(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DeepMineProspector(final DeepMineProspector card) {
        super(card);
    }

    @Override
    public DeepMineProspector copy() {
        return new DeepMineProspector(this);
    }
}
