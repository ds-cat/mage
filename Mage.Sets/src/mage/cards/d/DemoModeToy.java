 ...
 * @author TheElk801
 */
public final class DemoModeToy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DemoModeToy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DemoModeToy(final DemoModeToy card) {
        super(card);
    }

    @Override
    public DemoModeToy copy() {
        return new DemoModeToy(this);
    }
}
