 ...
 * @author TheElk801
 */
public final class DessertLands extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DessertLands(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DessertLands(final DessertLands card) {
        super(card);
    }

    @Override
    public DessertLands copy() {
        return new DessertLands(this);
    }
}
