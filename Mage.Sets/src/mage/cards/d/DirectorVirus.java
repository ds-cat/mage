 ...
 * @author TheElk801
 */
public final class DirectorVirus extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DirectorVirus(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DirectorVirus(final DirectorVirus card) {
        super(card);
    }

    @Override
    public DirectorVirus copy() {
        return new DirectorVirus(this);
    }
}
