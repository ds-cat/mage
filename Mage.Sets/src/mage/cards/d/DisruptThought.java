 ...
 * @author TheElk801
 */
public final class DisruptThought extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DisruptThought(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DisruptThought(final DisruptThought card) {
        super(card);
    }

    @Override
    public DisruptThought copy() {
        return new DisruptThought(this);
    }
}
