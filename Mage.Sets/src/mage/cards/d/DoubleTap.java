 ...
 * @author TheElk801
 */
public final class DoubleTap extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DoubleTap(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DoubleTap(final DoubleTap card) {
        super(card);
    }

    @Override
    public DoubleTap copy() {
        return new DoubleTap(this);
    }
}
