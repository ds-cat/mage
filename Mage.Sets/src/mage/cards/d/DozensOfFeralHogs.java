 ...
 * @author TheElk801
 */
public final class DozensOfFeralHogs extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DozensOfFeralHogs(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DozensOfFeralHogs(final DozensOfFeralHogs card) {
        super(card);
    }

    @Override
    public DozensOfFeralHogs copy() {
        return new DozensOfFeralHogs(this);
    }
}
