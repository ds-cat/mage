 ...
 * @author TheElk801
 */
public final class DrainCreativity extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DrainCreativity(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DrainCreativity(final DrainCreativity card) {
        super(card);
    }

    @Override
    public DrainCreativity copy() {
        return new DrainCreativity(this);
    }
}
