 ...
 * @author TheElk801
 */
public final class DrainDisorder extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DrainDisorder(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DrainDisorder(final DrainDisorder card) {
        super(card);
    }

    @Override
    public DrainDisorder copy() {
        return new DrainDisorder(this);
    }
}
