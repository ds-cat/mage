 ...
 * @author TheElk801
 */
public final class DrainEnergy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DrainEnergy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DrainEnergy(final DrainEnergy card) {
        super(card);
    }

    @Override
    public DrainEnergy copy() {
        return new DrainEnergy(this);
    }
}
