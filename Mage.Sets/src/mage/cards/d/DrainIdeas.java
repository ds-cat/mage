 ...
 * @author TheElk801
 */
public final class DrainIdeas extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DrainIdeas(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DrainIdeas(final DrainIdeas card) {
        super(card);
    }

    @Override
    public DrainIdeas copy() {
        return new DrainIdeas(this);
    }
}
