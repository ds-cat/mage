 ...
 * @author TheElk801
 */
public final class DrainResources extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DrainResources(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DrainResources(final DrainResources card) {
        super(card);
    }

    @Override
    public DrainResources copy() {
        return new DrainResources(this);
    }
}
