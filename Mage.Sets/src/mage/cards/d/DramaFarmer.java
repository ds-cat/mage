 ...
 * @author TheElk801
 */
public final class DramaFarmer extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DramaFarmer(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DramaFarmer(final DramaFarmer card) {
        super(card);
    }

    @Override
    public DramaFarmer copy() {
        return new DramaFarmer(this);
    }
}
