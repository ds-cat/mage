 ...
 * @author TheElk801
 */
public final class DreamGlider extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DreamGlider(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DreamGlider(final DreamGlider card) {
        super(card);
    }

    @Override
    public DreamGlider copy() {
        return new DreamGlider(this);
    }
}
