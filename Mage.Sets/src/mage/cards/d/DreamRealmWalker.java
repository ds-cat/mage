 ...
 * @author TheElk801
 */
public final class DreamRealmWalker extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DreamRealmWalker(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DreamRealmWalker(final DreamRealmWalker card) {
        super(card);
    }

    @Override
    public DreamRealmWalker copy() {
        return new DreamRealmWalker(this);
    }
}
