 ...
 * @author TheElk801
 */
public final class DreamsOfSlop extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DreamsOfSlop(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DreamsOfSlop(final DreamsOfSlop card) {
        super(card);
    }

    @Override
    public DreamsOfSlop copy() {
        return new DreamsOfSlop(this);
    }
}
