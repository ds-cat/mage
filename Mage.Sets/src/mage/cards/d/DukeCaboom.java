 ...
 * @author TheElk801
 */
public final class DukeCaboom extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public DukeCaboom(UUID ownerId, CardSetInfo setInfo) {
    ...
    private DukeCaboom(final DukeCaboom card) {
        super(card);
    }

    @Override
    public DukeCaboom copy() {
        return new DukeCaboom(this);
    }
}
