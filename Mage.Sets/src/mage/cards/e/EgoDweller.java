 ...
 * @author TheElk801
 */
public final class EgoDweller extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EgoDweller(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EgoDweller(final EgoDweller card) {
        super(card);
    }

    @Override
    public EgoDweller copy() {
        return new EgoDweller(this);
    }
}
