 ...
 * @author TheElk801
 */
public final class EidolonOfCreativeBankruptcy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EidolonOfCreativeBankruptcy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EidolonOfCreativeBankruptcy(final EidolonOfCreativeBankruptcy card) {
        super(card);
    }

    @Override
    public EidolonOfCreativeBankruptcy copy() {
        return new EidolonOfCreativeBankruptcy(this);
    }
}
