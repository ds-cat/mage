 ...
 * @author TheElk801
 */
public final class EmbraceOblivionSlop extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EmbraceOblivionSlop(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EmbraceOblivionSlop(final EmbraceOblivionSlop card) {
        super(card);
    }

    @Override
    public EmbraceOblivionSlop copy() {
        return new EmbraceOblivionSlop(this);
    }
}
