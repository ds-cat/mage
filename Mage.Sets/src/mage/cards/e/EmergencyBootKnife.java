 ...
 * @author TheElk801
 */
public final class EmergencyBootKnife extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EmergencyBootKnife(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EmergencyBootKnife(final EmergencyBootKnife card) {
        super(card);
    }

    @Override
    public EmergencyBootKnife copy() {
        return new EmergencyBootKnife(this);
    }
}
