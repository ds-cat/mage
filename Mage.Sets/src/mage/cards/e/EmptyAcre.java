 ...
 * @author TheElk801
 */
public final class EmptyAcre extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EmptyAcre(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EmptyAcre(final EmptyAcre card) {
        super(card);
    }

    @Override
    public EmptyAcre copy() {
        return new EmptyAcre(this);
    }
}
