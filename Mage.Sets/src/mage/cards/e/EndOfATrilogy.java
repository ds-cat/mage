 ...
 * @author TheElk801
 */
public final class EndOfATrilogy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EndOfATrilogy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EndOfATrilogy(final EndOfATrilogy card) {
        super(card);
    }

    @Override
    public EndOfATrilogy copy() {
        return new EndOfATrilogy(this);
    }
}
