 ...
 * @author TheElk801
 */
public final class EruptingNexus extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EruptingNexus(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EruptingNexus(final EruptingNexus card) {
        super(card);
    }

    @Override
    public EruptingNexus copy() {
        return new EruptingNexus(this);
    }
}
