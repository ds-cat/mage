 ...
 * @author TheElk801
 */
public final class EscapeThroughTime extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EscapeThroughTime(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EscapeThroughTime(final EscapeThroughTime card) {
        super(card);
    }

    @Override
    public EscapeThroughTime copy() {
        return new EscapeThroughTime(this);
    }
}
