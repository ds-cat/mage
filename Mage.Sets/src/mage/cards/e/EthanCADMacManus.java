 ...
 * @author TheElk801
 */
public final class EthanCADMacManus extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EthanCADMacManus(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EthanCADMacManus(final EthanCADMacManus card) {
        super(card);
    }

    @Override
    public EthanCADMacManus copy() {
        return new EthanCADMacManus(this);
    }
}
