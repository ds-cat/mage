 ...
 * @author TheElk801
 */
public final class EverythingAllAtOnce extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EverythingAllAtOnce(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EverythingAllAtOnce(final EverythingAllAtOnce card) {
        super(card);
    }

    @Override
    public EverythingAllAtOnce copy() {
        return new EverythingAllAtOnce(this);
    }
}
