 ...
 * @author TheElk801
 */
public final class ExiledWoody extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ExiledWoody(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ExiledWoody(final ExiledWoody card) {
        super(card);
    }

    @Override
    public ExiledWoody copy() {
        return new ExiledWoody(this);
    }
}
