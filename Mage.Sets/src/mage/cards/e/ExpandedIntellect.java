 ...
 * @author TheElk801
 */
public final class ExpandedIntellect extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ExpandedIntellect(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ExpandedIntellect(final ExpandedIntellect card) {
        super(card);
    }

    @Override
    public ExpandedIntellect copy() {
        return new ExpandedIntellect(this);
    }
}
