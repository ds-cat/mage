 ...
 * @author TheElk801
 */
public final class ExpansionOfPlot extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ExpansionOfPlot(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ExpansionOfPlot(final ExpansionOfPlot card) {
        super(card);
    }

    @Override
    public ExpansionOfPlot copy() {
        return new ExpansionOfPlot(this);
    }
}
