 ...
 * @author TheElk801
 */
public final class ExplodedShip extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ExplodedShip(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ExplodedShip(final ExplodedShip card) {
        super(card);
    }

    @Override
    public ExplodedShip copy() {
