 ...
 * @author TheElk801
 */
public final class EyeOfMadness extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public EyeOfMadness(UUID ownerId, CardSetInfo setInfo) {
    ...
    private EyeOfMadness(final EyeOfMadness card) {
        super(card);
    }

    @Override
    public EyeOfMadness copy() {
        return new EyeOfMadness(this);
    }
}
