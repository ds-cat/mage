 ...
 * @author TheElk801
 */
public final class FadeIntoIrrelevance extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FadeIntoIrrelevance(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FadeIntoIrrelevance(final FadeIntoIrrelevance card) {
        super(card);
    }

    @Override
    public FadeIntoIrrelevance copy() {
        return new FadeIntoIrrelevance(this);
    }
}
