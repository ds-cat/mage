 ...
 * @author TheElk801
 */
public final class FaithInAndy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FaithInAndy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FaithInAndy(final FaithInAndy card) {
        super(card);
    }

    @Override
    public FaithInAndy copy() {
        return new FaithInAndy(this);
    }
}
