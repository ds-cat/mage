 ...
 * @author TheElk801
 */
public final class FallDownTheStairs extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FallDownTheStairs(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FallDownTheStairs(final FallDownTheStairs card) {
        super(card);
    }

    @Override
    public FallDownTheStairs copy() {
        return new FallDownTheStairs(this);
    }
}
