 ...
 * @author TheElk801
 */
public final class FallingWithStyle extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FallingWithStyle(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FallingWithStyle(final FallingWithStyle card) {
        super(card);
    }

    @Override
    public FallingWithStyle copy() {
        return new FallingWithStyle(this);
    }
}
