 ...
 * @author TheElk801
 */
public final class FallingWithoutStyle extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FallingWithoutStyle(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FallingWithoutStyle(final FallingWithoutStyle card) {
        super(card);
    }

    @Override
    public FallingWithoutStyle copy() {
        return new FallingWithoutStyle(this);
    }
}
