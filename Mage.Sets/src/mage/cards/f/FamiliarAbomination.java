 ...
 * @author TheElk801
 */
public final class FamiliarAbomination extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FamiliarAbomination(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FamiliarAbomination(final FamiliarAbomination card) {
        super(card);
    }

    @Override
    public FamiliarAbomination copy() {
        return new FamiliarAbomination(this);
    }
}
