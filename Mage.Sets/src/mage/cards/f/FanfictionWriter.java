 ...
 * @author TheElk801
 */
public final class FanfictionWriter extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FanfictionWriter(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FanfictionWriter(final FanfictionWriter card) {
        super(card);
    }

    @Override
    public FanfictionWriter copy() {
        return new FanfictionWriter(this);
    }
}
