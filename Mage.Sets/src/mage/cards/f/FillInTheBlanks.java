 ...
 * @author TheElk801
 */
public final class FillInTheBlanks extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FillInTheBlanks(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FillInTheBlanks(final FillInTheBlanks card) {
        super(card);
    }

    @Override
    public FillInTheBlanks copy() {
        return new FillInTheBlanks(this);
    }
}
