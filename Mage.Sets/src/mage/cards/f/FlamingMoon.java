 ...
 * @author TheElk801
 */
public final class FlamingMoon extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FlamingMoon(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FlamingMoon(final FlamingMoon card) {
        super(card);
    }

    @Override
    public FlamingMoon copy() {
        return new FlamingMoon(this);
    }
}
