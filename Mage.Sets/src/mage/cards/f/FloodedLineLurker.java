 ...
 * @author TheElk801
 */
public final class FloodedLineLurker extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FloodedLineLurker(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FloodedLineLurker(final FloodedLineLurker card) {
        super(card);
    }

    @Override
    public FloodedLineLurker copy() {
        return new FloodedLineLurker(this);
    }
}
