 ...
 * @author TheElk801
 */
public final class ForgetIdea extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ForgetIdea(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ForgetIdea(final ForgetIdea card) {
        super(card);
    }

    @Override
    public ForgetIdea copy() {
        return new ForgetIdea(this);
    }
}
