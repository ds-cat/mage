 ...
 * @author TheElk801
 */
public final class ForgottenPlotlines extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ForgottenPlotlines(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ForgottenPlotlines(final ForgottenPlotlines card) {
        super(card);
    }

    @Override
    public ForgottenPlotlines copy() {
        return new ForgottenPlotlines(this);
    }
}
