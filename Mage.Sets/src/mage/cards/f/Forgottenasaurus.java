 ...
 * @author TheElk801
 */
public final class Forgottenasaurus extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Forgottenasaurus(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Forgottenasaurus(final Forgottenasaurus card) {
        super(card);
    }

    @Override
    public Forgottenasaurus copy() {
        return new Forgottenasaurus(this);
    }
}
