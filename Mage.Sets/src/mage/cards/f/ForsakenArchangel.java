 ...
 * @author TheElk801
 */
public final class ForsakenArchangel extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ForsakenArchangel(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ForsakenArchangel(final ForsakenArchangel card) {
        super(card);
    }

    @Override
    public ForsakenArchangel copy() {
        return new ForsakenArchangel(this);
    }
}
