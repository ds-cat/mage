 ...
 * @author TheElk801
 */
public final class FrigidWaters extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FrigidWaters(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FrigidWaters(final FrigidWaters card) {
        super(card);
    }

    @Override
    public FrigidWaters copy() {
        return new FrigidWaters(this);
    }
}
