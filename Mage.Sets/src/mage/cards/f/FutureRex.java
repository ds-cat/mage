 ...
 * @author TheElk801
 */
public final class FutureRex extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public FutureRex(UUID ownerId, CardSetInfo setInfo) {
    ...
    private FutureRex(final FutureRex card) {
        super(card);
    }

    @Override
    public FutureRex copy() {
        return new FutureRex(this);
    }
}
