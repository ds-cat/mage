 ...
 * @author TheElk801
 */
public final class GanravParadoxicalScreamer extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public GanravParadoxicalScreamer(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GanravParadoxicalScreamer(final GanravParadoxicalScreamer card) {
        super(card);
    }

    @Override
    public GanravParadoxicalScreamer copy() {
        return new GanravParadoxicalScreamer(this);
    }
}
