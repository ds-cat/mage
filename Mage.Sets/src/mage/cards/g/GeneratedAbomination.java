 ...
 * @author TheElk801
 */
public final class GeneratedAbomination extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public GeneratedAbomination(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GeneratedAbomination(final GeneratedAbomination card) {
        super(card);
    }

    @Override
    public GeneratedAbomination copy() {
        return new GeneratedAbomination(this);
    }
}
