 ...
 * @author TheElk801
 */
public final class GenericBadGuy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public GenericBadGuy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GenericBadGuy(final GenericBadGuy card) {
        super(card);
    }

    @Override
    public GenericBadGuy copy() {
        return new GenericBadGuy(this);
    }
}
