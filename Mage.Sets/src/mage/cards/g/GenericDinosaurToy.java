 ...
 * @author TheElk801
 */
public final class GenericDinosaurToy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public GenericDinosaurToy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GenericDinosaurToy(final GenericDinosaurToy card) {
        super(card);
    }

    @Override
    public GenericDinosaurToy copy() {
        return new GenericDinosaurToy(this);
    }
}
