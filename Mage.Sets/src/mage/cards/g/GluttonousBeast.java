 ...
 * @author TheElk801
 */
public final class GluttonousBeast extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public GluttonousBeast(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GluttonousBeast(final GluttonousBeast card) {
        super(card);
    }

    @Override
    public GluttonousBeast copy() {
        return new GluttonousBeast(this);
    }
}
