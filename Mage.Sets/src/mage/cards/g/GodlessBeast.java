 ...
 * @author TheElk801
 */
public final class GodlessBeast extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public GodlessBeast(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GodlessBeast(final GodlessBeast card) {
        super(card);
    }

    @Override
    public GodlessBeast copy() {
        return new GodlessBeast(this);
    }
}
