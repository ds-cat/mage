 ...
 * @author TheElk801
 */
public final class GokuGreen extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public GokuGreen(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GokuGreen(final GokuGreen card) {
        super(card);
    }

    @Override
    public GokuGreen copy() {
        return new GokuGreen(this);
    }
}
