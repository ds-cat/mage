 ...
 * @author TheElk801
 */
public final class GrayMire extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public GrayMire(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GrayMire(final GrayMire card) {
        super(card);
    }

    @Override
    public GrayMire copy() {
        return new GrayMire(this);
    }
}
