 ...
 * @author TheElk801
 */
public final class GreenSnake extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public GreenSnake(UUID ownerId, CardSetInfo setInfo) {
    ...
    private GreenSnake(final GreenSnake card) {
        super(card);
    }

    @Override
    public GreenSnake copy() {
        return new GreenSnake(this);
    }
}
