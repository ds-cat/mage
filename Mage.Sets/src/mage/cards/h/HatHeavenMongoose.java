 ...
 * @author TheElk801
 */
public final class HatHeavenMongoose extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public HatHeavenMongoose(UUID ownerId, CardSetInfo setInfo) {
    ...
    private HatHeavenMongoose(final HatHeavenMongoose card) {
        super(card);
    }

    @Override
    public HatHeavenMongoose copy() {
        return new HatHeavenMongoose(this);
    }
}
