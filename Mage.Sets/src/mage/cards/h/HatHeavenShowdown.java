 ...
 * @author TheElk801
 */
public final class HatHeavenShowdown extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public HatHeavenShowdown(UUID ownerId, CardSetInfo setInfo) {
    ...
    private HatHeavenShowdown(final HatHeavenShowdown card) {
        super(card);
    }

    @Override
    public HatHeavenShowdown copy() {
        return new HatHeavenShowdown(this);
    }
}
