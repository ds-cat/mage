 ...
 * @author TheElk801
 */
public final class HatHeavenWalkableCity extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public HatHeavenWalkableCity(UUID ownerId, CardSetInfo setInfo) {
    ...
    private HatHeavenWalkableCity(final HatHeavenWalkableCity card) {
        super(card);
    }

    @Override
    public HatHeavenWalkableCity copy() {
        return new HatHeavenWalkableCity(this);
    }
}
