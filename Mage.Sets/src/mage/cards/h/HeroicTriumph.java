 ...
 * @author TheElk801
 */
public final class HeroicTriumph extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public HeroicTriumph(UUID ownerId, CardSetInfo setInfo) {
    ...
    private HeroicTriumph(final HeroicTriumph card) {
        super(card);
    }

    @Override
    public HeroicTriumph copy() {
        return new HeroicTriumph(this);
    }
}
