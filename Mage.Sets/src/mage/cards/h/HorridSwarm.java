 ...
 * @author TheElk801
 */
public final class HorridSwarm extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public HorridSwarm(UUID ownerId, CardSetInfo setInfo) {
    ...
    private HorridSwarm(final HorridSwarm card) {
        super(card);
    }

    @Override
    public HorridSwarm copy() {
        return new HorridSwarm(this);
    }
}
