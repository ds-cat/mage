 ...
 * @author TheElk801
 */
public final class HotShotDetective extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public HotShotDetective(UUID ownerId, CardSetInfo setInfo) {
    ...
    private HotShotDetective(final HotShotDetective card) {
        super(card);
    }

    @Override
    public HotShotDetective copy() {
        return new HotShotDetective(this);
    }
}
