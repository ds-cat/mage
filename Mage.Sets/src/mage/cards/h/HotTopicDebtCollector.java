 ...
 * @author TheElk801
 */
public final class HotTopicDebtCollector extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public HotTopicDebtCollector(UUID ownerId, CardSetInfo setInfo) {
    ...
    private HotTopicDebtCollector(final HotTopicDebtCollector card) {
        super(card);
    }

    @Override
    public HotTopicDebtCollector copy() {
        return new HotTopicDebtCollector(this);
    }
}
