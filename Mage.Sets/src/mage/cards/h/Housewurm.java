 ...
 * @author TheElk801
 */
public final class Housewurm extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Housewurm(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Housewurm(final Housewurm card) {
        super(card);
    }

    @Override
    public Housewurm copy() {
        return new Housewurm(this);
    }
}
