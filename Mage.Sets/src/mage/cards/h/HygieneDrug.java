 ...
 * @author TheElk801
 */
public final class HygieneDrug extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public HygieneDrug(UUID ownerId, CardSetInfo setInfo) {
    ...
    private HygieneDrug(final HygieneDrug card) {
        super(card);
    }

    @Override
    public HygieneDrug copy() {
        return new HygieneDrug(this);
    }
}
