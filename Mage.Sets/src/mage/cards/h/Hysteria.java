 ...
 * @author TheElk801
 */
public final class Hysteria extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Hysteria(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Hysteria(final Hysteria card) {
        super(card);
    }

    @Override
    public Hysteria copy() {
        return new Hysteria(this);
    }
}
