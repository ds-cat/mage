 ...
 * @author TheElk801
 */
public final class IdDweller extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public IdDweller(UUID ownerId, CardSetInfo setInfo) {
    ...
    private IdDweller(final IdDweller card) {
        super(card);
    }

    @Override
    public IdDweller copy() {
        return new IdDweller(this);
    }
}
