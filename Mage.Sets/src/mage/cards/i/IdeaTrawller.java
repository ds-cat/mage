 ...
 * @author TheElk801
 */
public final class IdeaTrawller extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public IdeaTrawller(UUID ownerId, CardSetInfo setInfo) {
    ...
    private IdeaTrawller(final IdeaTrawller card) {
        super(card);
    }

    @Override
    public IdeaTrawller copy() {
        return new IdeaTrawller(this);
    }
}
