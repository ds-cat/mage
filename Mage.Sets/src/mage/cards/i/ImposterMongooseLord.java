 ...
 * @author TheElk801
 */
public final class ImposterMongooseLord extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ImposterMongooseLord(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ImposterMongooseLord(final ImposterMongooseLord card) {
        super(card);
    }

    @Override
    public ImposterMongooseLord copy() {
        return new ImposterMongooseLord(this);
    }
}
