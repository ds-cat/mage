 ...
 * @author TheElk801
 */
public final class ImposterPiss extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ImposterPiss(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ImposterPiss(final ImposterPiss card) {
        super(card);
    }

    @Override
    public ImposterPiss copy() {
        return new ImposterPiss(this);
    }
}
