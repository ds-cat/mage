 ...
 * @author TheElk801
 */
public final class ImposterSnakeLord extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ImposterSnakeLord(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ImposterSnakeLord(final ImposterSnakeLord card) {
        super(card);
    }

    @Override
    public ImposterSnakeLord copy() {
        return new ImposterSnakeLord(this);
    }
}
