 ...
 * @author TheElk801
 */
public final class ImpoverishedScriptWriter extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ImpoverishedScriptWriter(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ImpoverishedScriptWriter(final ImpoverishedScriptWriter card) {
        super(card);
    }

    @Override
    public ImpoverishedScriptWriter copy() {
        return new ImpoverishedScriptWriter(this);
    }
}
