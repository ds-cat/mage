 ...
 * @author TheElk801
 */
public final class IncongruousGrowth extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public IncongruousGrowth(UUID ownerId, CardSetInfo setInfo) {
    ...
    private IncongruousGrowth(final IncongruousGrowth card) {
        super(card);
    }

    @Override
    public IncongruousGrowth copy() {
        return new IncongruousGrowth(this);
    }
}
