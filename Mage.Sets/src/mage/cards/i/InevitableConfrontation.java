 ...
 * @author TheElk801
 */
public final class InevitableConfrontation extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public InevitableConfrontation(UUID ownerId, CardSetInfo setInfo) {
    ...
    private InevitableConfrontation(final InevitableConfrontation card) {
        super(card);
    }

    @Override
    public InevitableConfrontation copy() {
        return new InevitableConfrontation(this);
    }
}
