 ...
 * @author TheElk801
 */
public final class Intellectualism extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Intellectualism(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Intellectualism(final Intellectualism card) {
        super(card);
    }

    @Override
    public Intellectualism copy() {
        return new Intellectualism(this);
    }
}
