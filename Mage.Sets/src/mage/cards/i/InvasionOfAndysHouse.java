 ...
 * @author TheElk801
 */
public final class InvasionOfAndysHouse extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public InvasionOfAndysHouse(UUID ownerId, CardSetInfo setInfo) {
    ...
    private InvasionOfAndysHouse(final InvasionOfAndysHouse card) {
        super(card);
    }

    @Override
    public InvasionOfAndysHouse copy() {
        return new InvasionOfAndysHouse(this);
    }
}
