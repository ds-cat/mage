 ...
 * @author TheElk801
 */
public final class ItThatBlanks extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ItThatBlanks(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ItThatBlanks(final ItThatBlanks card) {
        super(card);
    }

    @Override
    public ItThatBlanks copy() {
        return new ItThatBlanks(this);
    }
}
