 ...
 * @author TheElk801
 */
public final class ItThatBlooms extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ItThatBlooms(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ItThatBlooms(final ItThatBlooms card) {
        super(card);
    }

    @Override
    public ItThatBlooms copy() {
        return new ItThatBlooms(this);
    }
}
