 ...
 * @author TheElk801
 */
public final class JessiePlotDevice extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public JessiePlotDevice(UUID ownerId, CardSetInfo setInfo) {
    ...
    private JessiePlotDevice(final JessiePlotDevice card) {
        super(card);
    }

    @Override
    public JessiePlotDevice copy() {
        return new JessiePlotDevice(this);
    }
}
