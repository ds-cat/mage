 ...
 * @author TheElk801
 */
public final class JessieReluctantBackup extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public JessieReluctantBackup(UUID ownerId, CardSetInfo setInfo) {
    ...
    private JessieReluctantBackup(final JessieReluctantBackup card) {
        super(card);
    }

    @Override
    public JessieReluctantBackup copy() {
        return new JessieReluctantBackup(this);
    }
}
