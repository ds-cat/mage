 ...
 * @author TheElk801
 */
public final class JessieUnified extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public JessieUnified(UUID ownerId, CardSetInfo setInfo) {
    ...
    private JessieUnified(final JessieUnified card) {
        super(card);
    }

    @Override
    public JessieUnified copy() {
        return new JessieUnified(this);
    }
}
