 ...
 * @author TheElk801
 */
public final class KarlaInvadingInferno extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public KarlaInvadingInferno(UUID ownerId, CardSetInfo setInfo) {
    ...
    private KarlaInvadingInferno(final KarlaInvadingInferno card) {
        super(card);
    }

    @Override
    public KarlaInvadingInferno copy() {
        return new KarlaInvadingInferno(this);
    }
}
