 ...
 * @author TheElk801
 */
public final class KenBlankSlate extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public KenBlankSlate(UUID ownerId, CardSetInfo setInfo) {
    ...
    private KenBlankSlate(final KenBlankSlate card) {
        super(card);
    }

    @Override
    public KenBlankSlate copy() {
        return new KenBlankSlate(this);
    }
}
