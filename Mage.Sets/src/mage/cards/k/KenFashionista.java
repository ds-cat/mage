 ...
 * @author TheElk801
 */
public final class KenFashionista extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public KenFashionista(UUID ownerId, CardSetInfo setInfo) {
    ...
    private KenFashionista(final KenFashionista card) {
        super(card);
    }

    @Override
    public KenFashionista copy() {
        return new KenFashionista(this);
    }
}
