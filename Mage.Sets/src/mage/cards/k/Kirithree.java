 ...
 * @author TheElk801
 */
public final class Kirithree extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Kirithree(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Kirithree(final Kirithree card) {
        super(card);
    }

    @Override
    public Kirithree copy() {
        return new Kirithree(this);
    }
}
