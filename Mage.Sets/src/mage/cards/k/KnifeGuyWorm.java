 ...
 * @author TheElk801
 */
public final class KnifeGuyWorm extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public KnifeGuyWorm(UUID ownerId, CardSetInfo setInfo) {
    ...
    private KnifeGuyWorm(final KnifeGuyWorm card) {
        super(card);
    }

    @Override
    public KnifeGuyWorm copy() {
        return new KnifeGuyWorm(this);
    }
}
