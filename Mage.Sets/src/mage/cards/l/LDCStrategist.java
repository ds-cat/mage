 ...
 * @author TheElk801
 */
public final class LDCStrategist extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LDCStrategist(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LDCStrategist(final LDCStrategist card) {
        super(card);
    }

    @Override
    public LDCStrategist copy() {
        return new LDCStrategist(this);
    }
}
