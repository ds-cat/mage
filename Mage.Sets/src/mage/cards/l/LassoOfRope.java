 ...
 * @author TheElk801
 */
public final class LassoOfRope extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LassoOfRope(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LassoOfRope(final LassoOfRope card) {
        super(card);
    }

    @Override
    public LassoOfRope copy() {
        return new LassoOfRope(this);
    }
}
