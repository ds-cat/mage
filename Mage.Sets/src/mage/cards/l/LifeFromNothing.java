 ...
 * @author TheElk801
 */
public final class LifeFromNothing extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LifeFromNothing(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LifeFromNothing(final LifeFromNothing card) {
        super(card);
    }

    @Override
    public LifeFromNothing copy() {
        return new LifeFromNothing(this);
    }
}
