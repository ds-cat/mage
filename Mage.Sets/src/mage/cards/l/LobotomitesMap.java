 ...
 * @author TheElk801
 */
public final class LobotomitesMap extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LobotomitesMap(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LobotomitesMap(final LobotomitesMap card) {
        super(card);
    }

    @Override
    public LobotomitesMap copy() {
        return new LobotomitesMap(this);
    }
}
