 ...
 * @author TheElk801
 */
public final class LoremasterClass extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LoremasterClass(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LoremasterClass(final LoremasterClass card) {
        super(card);
    }

    @Override
    public LoremasterClass copy() {
        return new LoremasterClass(this);
    }
}
