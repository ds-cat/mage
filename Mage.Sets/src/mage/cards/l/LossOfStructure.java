 ...
 * @author TheElk801
 */
public final class LossOfStructure extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LossOfStructure(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LossOfStructure(final LossOfStructure card) {
        super(card);
    }

    @Override
    public LossOfStructure copy() {
        return new LossOfStructure(this);
    }
}
