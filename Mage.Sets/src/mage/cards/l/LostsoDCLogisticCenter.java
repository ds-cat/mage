 ...
 * @author TheElk801
 */
public final class LostsoDCLogisticCenter extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LostsoDCLogisticCenter(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LostsoDCLogisticCenter(final LostsoDCLogisticCenter card) {
        super(card);
    }

    @Override
    public LostsoDCLogisticCenter copy() {
        return new LostsoDCLogisticCenter(this);
    }
}
