 ...
 * @author TheElk801
 */
public final class LotsoCommander extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LotsoCommander(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LotsoCommander(final LotsoCommander card) {
        super(card);
    }

    @Override
    public LotsoCommander copy() {
        return new LotsoCommander(this);
    }
}
