 ...
 * @author TheElk801
 */
public final class LotsoDCPropagandas extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LotsoDCPropagandas(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LotsoDCPropagandas(final LotsoDCPropagandas card) {
        super(card);
    }

    @Override
    public LotsoDCPropagandas copy() {
        return new LotsoDCPropagandas(this);
    }
}
