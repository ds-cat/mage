 ...
 * @author TheElk801
 */
public final class LotsoDcRecuiter extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LotsoDcRecuiter(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LotsoDcRecuiter(final LotsoDcRecuiter card) {
        super(card);
    }

    @Override
    public LotsoDcRecuiter copy() {
        return new LotsoDcRecuiter(this);
    }
}
