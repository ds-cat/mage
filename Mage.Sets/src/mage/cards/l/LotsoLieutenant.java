 ...
 * @author TheElk801
 */
public final class LotsoLieutenant extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LotsoLieutenant(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LotsoLieutenant(final LotsoLieutenant card) {
        super(card);
    }

    @Override
    public LotsoLieutenant copy() {
        return new LotsoLieutenant(this);
    }
}
