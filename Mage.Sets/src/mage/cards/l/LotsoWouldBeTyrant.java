 ...
 * @author TheElk801
 */
public final class LotsoWouldBeTyrant extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LotsoWouldBeTyrant(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LotsoWouldBeTyrant(final LotsoWouldBeTyrant card) {
        super(card);
    }

    @Override
    public LotsoWouldBeTyrant copy() {
        return new LotsoWouldBeTyrant(this);
    }
}
