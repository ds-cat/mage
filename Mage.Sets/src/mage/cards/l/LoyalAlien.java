 ...
 * @author TheElk801
 */
public final class LoyalAlien extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LoyalAlien(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LoyalAlien(final LoyalAlien card) {
        super(card);
    }

    @Override
    public LoyalAlien copy() {
        return new LoyalAlien(this);
    }
}
