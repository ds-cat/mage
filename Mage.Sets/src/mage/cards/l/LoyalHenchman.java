 ...
 * @author TheElk801
 */
public final class LoyalHenchman extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LoyalHenchman(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LoyalHenchman(final LoyalHenchman card) {
        super(card);
    }

    @Override
    public LoyalHenchman copy() {
        return new LoyalHenchman(this);
    }
}
