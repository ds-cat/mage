 ...
 * @author TheElk801
 */
public final class LucasDavidowicz extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LucasDavidowicz(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LucasDavidowicz(final LucasDavidowicz card) {
        super(card);
    }

    @Override
    public LucasDavidowicz copy() {
        return new LucasDavidowicz(this);
    }
}
