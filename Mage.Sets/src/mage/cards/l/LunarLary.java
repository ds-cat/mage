 ...
 * @author TheElk801
 */
public final class LunarLary extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public LunarLary(UUID ownerId, CardSetInfo setInfo) {
    ...
    private LunarLary(final LunarLary card) {
        super(card);
    }

    @Override
    public LunarLary copy() {
        return new LunarLary(this);
    }
}
