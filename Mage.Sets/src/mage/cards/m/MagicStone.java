 ...
 * @author TheElk801
 */
public final class MagicStone extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MagicStone(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MagicStone(final MagicStone card) {
        super(card);
    }

    @Override
    public MagicStone copy() {
        return new MagicStone(this);
    }
}
