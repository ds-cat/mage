 ...
 * @author TheElk801
 */
public final class MagicalEnlargment extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MagicalEnlargment(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MagicalEnlargment(final MagicalEnlargment card) {
        super(card);
    }

    @Override
    public MagicalEnlargment copy() {
        return new MagicalEnlargment(this);
    }
}
