 ...
 * @author TheElk801
 */
public final class MainCharacterSyndrome extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MainCharacterSyndrome(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MainCharacterSyndrome(final MainCharacterSyndrome card) {
        super(card);
    }

    @Override
    public MainCharacterSyndrome copy() {
        return new MainCharacterSyndrome(this);
    }
}
