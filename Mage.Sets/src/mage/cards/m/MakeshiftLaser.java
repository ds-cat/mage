 ...
 * @author TheElk801
 */
public final class MakeshiftLaser extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MakeshiftLaser(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MakeshiftLaser(final MakeshiftLaser card) {
        super(card);
    }

    @Override
    public MakeshiftLaser copy() {
        return new MakeshiftLaser(this);
    }
}
