 ...
 * @author TheElk801
 */
public final class MaliciousImprint extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MaliciousImprint(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MaliciousImprint(final MaliciousImprint card) {
        super(card);
    }

    @Override
    public MaliciousImprint copy() {
        return new MaliciousImprint(this);
    }
}
