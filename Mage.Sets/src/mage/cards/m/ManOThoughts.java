 ...
 * @author TheElk801
 */
public final class ManOThoughts extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ManOThoughts(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ManOThoughts(final ManOThoughts card) {
        super(card);
    }

    @Override
    public ManOThoughts copy() {
        return new ManOThoughts(this);
    }
}
