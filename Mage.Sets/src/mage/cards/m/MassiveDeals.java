 ...
 * @author TheElk801
 */
public final class MassiveDeals extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MassiveDeals(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MassiveDeals(final MassiveDeals card) {
        super(card);
    }

    @Override
    public MassiveDeals copy() {
        return new MassiveDeals(this);
    }
}
