 ...
 * @author TheElk801
 */
public final class MeaninglessCase extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MeaninglessCase(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MeaninglessCase(final MeaninglessCase card) {
        super(card);
    }

    @Override
    public MeaninglessCase copy() {
        return new MeaninglessCase(this);
    }
}
