 ...
 * @author TheElk801
 */
public final class MeticulousPlanner extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MeticulousPlanner(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MeticulousPlanner(final MeticulousPlanner card) {
        super(card);
    }

    @Override
    public MeticulousPlanner copy() {
        return new MeticulousPlanner(this);
    }
}
