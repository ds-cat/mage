 ...
 * @author TheElk801
 */
public final class MindTrust extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MindTrust(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MindTrust(final MindTrust card) {
        super(card);
    }

    @Override
    public MindTrust copy() {
        return new MindTrust(this);
    }
}
