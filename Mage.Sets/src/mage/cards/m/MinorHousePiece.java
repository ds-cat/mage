 ...
 * @author TheElk801
 */
public final class MinorHousePiece extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MinorHousePiece(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MinorHousePiece(final MinorHousePiece card) {
        super(card);
    }

    @Override
    public MinorHousePiece copy() {
        return new MinorHousePiece(this);
    }
}
