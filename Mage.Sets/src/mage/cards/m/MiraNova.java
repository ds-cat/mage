 ...
 * @author TheElk801
 */
public final class MiraNova extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MiraNova(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MiraNova(final MiraNova card) {
        super(card);
    }

    @Override
    public MiraNova copy() {
        return new MiraNova(this);
    }
}
