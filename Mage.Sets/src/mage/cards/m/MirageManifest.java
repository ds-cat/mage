 ...
 * @author TheElk801
 */
public final class MirageManifest extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MirageManifest(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MirageManifest(final MirageManifest card) {
        super(card);
    }

    @Override
    public MirageManifest copy() {
        return new MirageManifest(this);
    }
}
