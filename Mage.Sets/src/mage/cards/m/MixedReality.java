 ...
 * @author TheElk801
 */
public final class MixedReality extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MixedReality(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MixedReality(final MixedReality card) {
        super(card);
    }

    @Override
    public MixedReality copy() {
        return new MixedReality(this);
    }
}
