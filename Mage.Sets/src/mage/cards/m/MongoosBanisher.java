 ...
 * @author TheElk801
 */
public final class MongoosBanisher extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MongoosBanisher(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MongoosBanisher(final MongoosBanisher card) {
        super(card);
    }

    @Override
    public MongoosBanisher copy() {
        return new MongoosBanisher(this);
    }
}
