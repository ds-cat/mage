 ...
 * @author TheElk801
 */
public final class MongooseAccountant extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MongooseAccountant(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MongooseAccountant(final MongooseAccountant card) {
        super(card);
    }

    @Override
    public MongooseAccountant copy() {
        return new MongooseAccountant(this);
    }
}
