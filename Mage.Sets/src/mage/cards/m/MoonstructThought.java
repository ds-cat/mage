 ...
 * @author TheElk801
 */
public final class MoonstructThought extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MoonstructThought(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MoonstructThought(final MoonstructThought card) {
        super(card);
    }

    @Override
    public MoonstructThought copy() {
        return new MoonstructThought(this);
    }
}
