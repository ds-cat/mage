 ...
 * @author TheElk801
 */
public final class MountKibble extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MountKibble(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MountKibble(final MountKibble card) {
        super(card);
    }

    @Override
    public MountKibble copy() {
        return new MountKibble(this);
    }
}
