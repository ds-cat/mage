 ...
 * @author TheElk801
 */
public final class MrEvilDrPorkchop extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MrEvilDrPorkchop(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MrEvilDrPorkchop(final MrEvilDrPorkchop card) {
        super(card);
    }

    @Override
    public MrEvilDrPorkchop copy() {
        return new MrEvilDrPorkchop(this);
    }
}
