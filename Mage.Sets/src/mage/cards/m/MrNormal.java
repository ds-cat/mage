 ...
 * @author TheElk801
 */
public final class MrNormal extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MrNormal(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MrNormal(final MrNormal card) {
        super(card);
    }

    @Override
    public MrNormal copy() {
        return new MrNormal(this);
    }
}
