 ...
 * @author TheElk801
 */
public final class MrSleepy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MrSleepy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MrSleepy(final MrSleepy card) {
        super(card);
    }

    @Override
    public MrSleepy copy() {
        return new MrSleepy(this);
    }
}
