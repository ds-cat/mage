 ...
 * @author TheElk801
 */
public final class MsKibble extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MsKibble(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MsKibble(final MsKibble card) {
        super(card);
    }

    @Override
    public MsKibble copy() {
        return new MsKibble(this);
    }
}
