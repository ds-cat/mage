 ...
 * @author TheElk801
 */
public final class MutantBear extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public MutantBear(UUID ownerId, CardSetInfo setInfo) {
    ...
    private MutantBear(final MutantBear card) {
        super(card);
    }

    @Override
    public MutantBear copy() {
        return new MutantBear(this);
    }
}
