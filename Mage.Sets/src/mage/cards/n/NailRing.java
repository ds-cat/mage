 ...
 * @author TheElk801
 */
public final class NailRing extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public NailRing(UUID ownerId, CardSetInfo setInfo) {
    ...
    private NailRing(final NailRing card) {
        super(card);
    }

    @Override
    public NailRing copy() {
        return new NailRing(this);
    }
}
