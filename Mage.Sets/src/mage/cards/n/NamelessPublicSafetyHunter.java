 ...
 * @author TheElk801
 */
public final class NamelessPublicSafetyHunter extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public NamelessPublicSafetyHunter(UUID ownerId, CardSetInfo setInfo) {
    ...
    private NamelessPublicSafetyHunter(final NamelessPublicSafetyHunter card) {
        super(card);
    }

    @Override
    public NamelessPublicSafetyHunter copy() {
        return new NamelessPublicSafetyHunter(this);
    }
}
