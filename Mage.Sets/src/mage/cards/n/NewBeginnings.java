 ...
 * @author TheElk801
 */
public final class NewBeginnings extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public NewBeginnings(UUID ownerId, CardSetInfo setInfo) {
    ...
    private NewBeginnings(final NewBeginnings card) {
        super(card);
    }

    @Override
    public NewBeginnings copy() {
        return new NewBeginnings(this);
    }
}
