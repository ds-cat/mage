 ...
 * @author TheElk801
 */
public final class OCWriter extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public OCWriter(UUID ownerId, CardSetInfo setInfo) {
    ...
    private OCWriter(final OCWriter card) {
        super(card);
    }

    @Override
    public OCWriter copy() {
        return new OCWriter(this);
    }
}
