 ...
 * @author TheElk801
 */
public final class OffscreanTraining extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public OffscreanTraining(UUID ownerId, CardSetInfo setInfo) {
    ...
    private OffscreanTraining(final OffscreanTraining card) {
        super(card);
    }

    @Override
    public OffscreanTraining copy() {
        return new OffscreanTraining(this);
    }
}
