 ...
 * @author TheElk801
 */
public final class OpenRecasts extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public OpenRecasts(UUID ownerId, CardSetInfo setInfo) {
    ...
    private OpenRecasts(final OpenRecasts card) {
        super(card);
    }

    @Override
    public OpenRecasts copy() {
        return new OpenRecasts(this);
    }
}
