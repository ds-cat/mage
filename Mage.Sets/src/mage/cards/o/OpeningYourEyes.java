 ...
 * @author TheElk801
 */
public final class OpeningYourEyes extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public OpeningYourEyes(UUID ownerId, CardSetInfo setInfo) {
    ...
    private OpeningYourEyes(final OpeningYourEyes card) {
        super(card);
    }

    @Override
    public OpeningYourEyes copy() {
        return new OpeningYourEyes(this);
    }
}
