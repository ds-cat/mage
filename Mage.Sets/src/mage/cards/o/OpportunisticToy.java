 ...
 * @author TheElk801
 */
public final class OpportunisticToy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public OpportunisticToy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private OpportunisticToy(final OpportunisticToy card) {
        super(card);
    }

    @Override
    public OpportunisticToy copy() {
        return new OpportunisticToy(this);
    }
}
