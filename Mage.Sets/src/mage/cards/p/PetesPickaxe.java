 ...
 * @author TheElk801
 */
public final class PetesPickaxe extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public PetesPickaxe(UUID ownerId, CardSetInfo setInfo) {
    ...
    private PetesPickaxe(final PetesPickaxe card) {
        super(card);
    }

    @Override
    public PetesPickaxe copy() {
        return new PetesPickaxe(this);
    }
}
