 ...
 * @author TheElk801
 */
public final class PizzaPlanetDeliveryCar extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public PizzaPlanetDeliveryCar(UUID ownerId, CardSetInfo setInfo) {
    ...
    private PizzaPlanetDeliveryCar(final PizzaPlanetDeliveryCar card) {
        super(card);
    }

    @Override
    public PizzaPlanetDeliveryCar copy() {
        return new PizzaPlanetDeliveryCar(this);
    }
}
