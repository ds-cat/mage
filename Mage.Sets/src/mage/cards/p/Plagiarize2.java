 ...
 * @author TheElk801
 */
public final class Plagiarize2 extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Plagiarize2(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Plagiarize2(final Plagiarize2 card) {
        super(card);
    }

    @Override
    public Plagiarize2 copy() {
        return new Plagiarize2(this);
    }
}
