 ...
 * @author TheElk801
 */
public final class PlasticAbomination extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public PlasticAbomination(UUID ownerId, CardSetInfo setInfo) {
    ...
    private PlasticAbomination(final PlasticAbomination card) {
        super(card);
    }

    @Override
    public PlasticAbomination copy() {
        return new PlasticAbomination(this);
    }
}
