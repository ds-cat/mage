 ...
 * @author TheElk801
 */
public final class PlasticineDrake extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public PlasticineDrake(UUID ownerId, CardSetInfo setInfo) {
    ...
    private PlasticineDrake(final PlasticineDrake card) {
        super(card);
    }

    @Override
    public PlasticineDrake copy() {
        return new PlasticineDrake(this);
    }
}
