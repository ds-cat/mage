 ...
 * @author TheElk801
 */
public final class PlotConvenience extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public PlotConvenience(UUID ownerId, CardSetInfo setInfo) {
    ...
    private PlotConvenience(final PlotConvenience card) {
        super(card);
    }

    @Override
    public PlotConvenience copy() {
        return new PlotConvenience(this);
    }
}
