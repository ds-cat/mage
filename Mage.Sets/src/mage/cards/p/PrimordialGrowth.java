 ...
 * @author TheElk801
 */
public final class PrimordialGrowth extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public PrimordialGrowth(UUID ownerId, CardSetInfo setInfo) {
    ...
    private PrimordialGrowth(final PrimordialGrowth card) {
        super(card);
    }

    @Override
    public PrimordialGrowth copy() {
        return new PrimordialGrowth(this);
    }
}
