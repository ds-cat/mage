 ...
 * @author TheElk801
 */
public final class ProspectorMines extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ProspectorMines(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ProspectorMines(final ProspectorMines card) {
        super(card);
    }

    @Override
    public ProspectorMines copy() {
        return new ProspectorMines(this);
    }
}
