 ...
 * @author TheElk801
 */
public final class ProspectorOutfit extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ProspectorOutfit(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ProspectorOutfit(final ProspectorOutfit card) {
        super(card);
    }

    @Override
    public ProspectorOutfit copy() {
        return new ProspectorOutfit(this);
    }
}
