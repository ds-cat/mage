 ...
 * @author TheElk801
 */
public final class ProspectorProfessor extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ProspectorProfessor(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ProspectorProfessor(final ProspectorProfessor card) {
        super(card);
    }

    @Override
    public ProspectorProfessor copy() {
        return new ProspectorProfessor(this);
    }
}
