 ...
 * @author TheElk801
 */
public final class PsychosisPhantasm extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public PsychosisPhantasm(UUID ownerId, CardSetInfo setInfo) {
    ...
    private PsychosisPhantasm(final PsychosisPhantasm card) {
        super(card);
    }

    @Override
    public PsychosisPhantasm copy() {
        return new PsychosisPhantasm(this);
    }
}
