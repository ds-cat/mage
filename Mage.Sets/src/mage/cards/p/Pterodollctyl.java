 ...
 * @author TheElk801
 */
public final class Pterodollctyl extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Pterodollctyl(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Pterodollctyl(final Pterodollctyl card) {
        super(card);
    }

    @Override
    public Pterodollctyl copy() {
        return new Pterodollctyl(this);
    }
}
