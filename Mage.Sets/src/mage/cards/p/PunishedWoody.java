 ...
 * @author TheElk801
 */
public final class PunishedWoody extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public PunishedWoody(UUID ownerId, CardSetInfo setInfo) {
    ...
    private PunishedWoody(final PunishedWoody card) {
        super(card);
    }

    @Override
    public PunishedWoody copy() {
        return new PunishedWoody(this);
    }
}
