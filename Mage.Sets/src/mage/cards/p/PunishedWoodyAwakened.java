 ...
 * @author TheElk801
 */
public final class PunishedWoodyAwakened extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public PunishedWoodyAwakened(UUID ownerId, CardSetInfo setInfo) {
    ...
    private PunishedWoodyAwakened(final PunishedWoodyAwakened card) {
        super(card);
    }

    @Override
    public PunishedWoodyAwakened copy() {
        return new PunishedWoodyAwakened(this);
    }
}
