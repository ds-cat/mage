 ...
 * @author TheElk801
 */
public final class QuickDraw2 extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public QuickDraw2(UUID ownerId, CardSetInfo setInfo) {
    ...
    private QuickDraw2(final QuickDraw2 card) {
        super(card);
    }

    @Override
    public QuickDraw2 copy() {
        return new QuickDraw2(this);
    }
}
