 ...
 * @author TheElk801
 */
public final class RamonaFlowersSubwaySurfer extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public RamonaFlowersSubwaySurfer(UUID ownerId, CardSetInfo setInfo) {
    ...
    private RamonaFlowersSubwaySurfer(final RamonaFlowersSubwaySurfer card) {
        super(card);
    }

    @Override
    public RamonaFlowersSubwaySurfer copy() {
        return new RamonaFlowersSubwaySurfer(this);
    }
}
