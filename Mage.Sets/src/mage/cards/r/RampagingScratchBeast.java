 ...
 * @author TheElk801
 */
public final class RampagingScratchBeast extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public RampagingScratchBeast(UUID ownerId, CardSetInfo setInfo) {
    ...
    private RampagingScratchBeast(final RampagingScratchBeast card) {
        super(card);
    }

    @Override
    public RampagingScratchBeast copy() {
        return new RampagingScratchBeast(this);
    }
}
