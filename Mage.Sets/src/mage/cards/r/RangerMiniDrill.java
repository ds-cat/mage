 ...
 * @author TheElk801
 */
public final class RangerMiniDrill extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public RangerMiniDrill(UUID ownerId, CardSetInfo setInfo) {
    ...
    private RangerMiniDrill(final RangerMiniDrill card) {
        super(card);
    }

    @Override
    public RangerMiniDrill copy() {
        return new RangerMiniDrill(this);
    }
}
