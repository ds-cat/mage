 ...
 * @author TheElk801
 */
public final class ReapersPenumbra extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ReapersPenumbra(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ReapersPenumbra(final ReapersPenumbra card) {
        super(card);
    }

    @Override
    public ReapersPenumbra copy() {
        return new ReapersPenumbra(this);
    }
}
