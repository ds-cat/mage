 ...
 * @author TheElk801
 */
public final class Recalibrate2 extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Recalibrate2(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Recalibrate2(final Recalibrate2 card) {
        super(card);
    }

    @Override
    public Recalibrate2 copy() {
        return new Recalibrate2(this);
    }
}
