 ...
 * @author TheElk801
 */
public final class RefreshedMind extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public RefreshedMind(UUID ownerId, CardSetInfo setInfo) {
    ...
    private RefreshedMind(final RefreshedMind card) {
        super(card);
    }

    @Override
    public RefreshedMind copy() {
        return new RefreshedMind(this);
    }
}
