 ...
 * @author TheElk801
 */
public final class ReoccuringVillan extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ReoccuringVillan(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ReoccuringVillan(final ReoccuringVillan card) {
        super(card);
    }

    @Override
    public ReoccuringVillan copy() {
        return new ReoccuringVillan(this);
    }
}
