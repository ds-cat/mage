 ...
 * @author TheElk801
 */
public final class ResearchGenerator extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ResearchGenerator(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ResearchGenerator(final ResearchGenerator card) {
        super(card);
    }

    @Override
    public ResearchGenerator copy() {
        return new ResearchGenerator(this);
    }
}
