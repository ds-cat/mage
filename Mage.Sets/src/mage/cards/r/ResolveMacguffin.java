 ...
 * @author TheElk801
 */
public final class ResolveMacguffin extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ResolveMacguffin(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ResolveMacguffin(final ResolveMacguffin card) {
        super(card);
    }

    @Override
    public ResolveMacguffin copy() {
        return new ResolveMacguffin(this);
    }
}
