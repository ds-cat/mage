 ...
 * @author TheElk801
 */
public final class Resurfacing extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Resurfacing(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Resurfacing(final Resurfacing card) {
        super(card);
    }

    @Override
    public Resurfacing copy() {
        return new Resurfacing(this);
    }
}
