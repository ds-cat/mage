 ...
 * @author TheElk801
 */
public final class ResurrectionOfTheOldOne extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ResurrectionOfTheOldOne(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ResurrectionOfTheOldOne(final ResurrectionOfTheOldOne card) {
        super(card);
    }

    @Override
    public ResurrectionOfTheOldOne copy() {
        return new ResurrectionOfTheOldOne(this);
    }
}
