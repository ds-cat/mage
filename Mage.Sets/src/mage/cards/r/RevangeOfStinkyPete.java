 ...
 * @author TheElk801
 */
public final class RevangeOfStinkyPete extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public RevangeOfStinkyPete(UUID ownerId, CardSetInfo setInfo) {
    ...
    private RevangeOfStinkyPete(final RevangeOfStinkyPete card) {
        super(card);
    }

    @Override
    public RevangeOfStinkyPete copy() {
        return new RevangeOfStinkyPete(this);
    }
}
