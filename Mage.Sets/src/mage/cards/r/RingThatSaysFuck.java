 ...
 * @author TheElk801
 */
public final class RingThatSaysFuck extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public RingThatSaysFuck(UUID ownerId, CardSetInfo setInfo) {
    ...
    private RingThatSaysFuck(final RingThatSaysFuck card) {
        super(card);
    }

    @Override
    public RingThatSaysFuck copy() {
        return new RingThatSaysFuck(this);
    }
}
