 ...
 * @author TheElk801
 */
public final class RushedDeadlines extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public RushedDeadlines(UUID ownerId, CardSetInfo setInfo) {
    ...
    private RushedDeadlines(final RushedDeadlines card) {
        super(card);
    }

    @Override
    public RushedDeadlines copy() {
        return new RushedDeadlines(this);
    }
}
