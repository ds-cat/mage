 ...
 * @author TheElk801
 */
public final class SakuraHokage extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SakuraHokage(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SakuraHokage(final SakuraHokage card) {
        super(card);
    }

    @Override
    public SakuraHokage copy() {
        return new SakuraHokage(this);
    }
}
