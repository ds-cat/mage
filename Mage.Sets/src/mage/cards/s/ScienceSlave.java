 ...
 * @author TheElk801
 */
public final class ScienceSlave extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ScienceSlave(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ScienceSlave(final ScienceSlave card) {
        super(card);
    }

    @Override
    public ScienceSlave copy() {
        return new ScienceSlave(this);
    }
}
