 ...
 * @author TheElk801
 */
public final class ScratchFlameDrake extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ScratchFlameDrake(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ScratchFlameDrake(final ScratchFlameDrake card) {
        super(card);
    }

    @Override
    public ScratchFlameDrake copy() {
        return new ScratchFlameDrake(this);
    }
}
