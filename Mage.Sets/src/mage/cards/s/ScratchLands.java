 ...
 * @author TheElk801
 */
public final class ScratchLands extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ScratchLands(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ScratchLands(final ScratchLands card) {
        super(card);
    }

    @Override
    public ScratchLands copy() {
        return new ScratchLands(this);
    }
}
