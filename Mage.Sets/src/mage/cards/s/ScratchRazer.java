 ...
 * @author TheElk801
 */
public final class ScratchRazer extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ScratchRazer(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ScratchRazer(final ScratchRazer card) {
        super(card);
    }

    @Override
    public ScratchRazer copy() {
        return new ScratchRazer(this);
    }
}
