 ...
 * @author TheElk801
 */
public final class ScratchWave extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ScratchWave(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ScratchWave(final ScratchWave card) {
        super(card);
    }

    @Override
    public ScratchWave copy() {
        return new ScratchWave(this);
    }
}
