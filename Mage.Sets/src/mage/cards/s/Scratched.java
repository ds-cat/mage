 ...
 * @author TheElk801
 */
public final class Scratched extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Scratched(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Scratched(final Scratched card) {
        super(card);
    }

    @Override
    public Scratched copy() {
        return new Scratched(this);
    }
}
