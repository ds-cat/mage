 ...
 * @author TheElk801
 */
public final class Scratchgofy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Scratchgofy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Scratchgofy(final Scratchgofy card) {
        super(card);
    }

    @Override
    public Scratchgofy copy() {
        return new Scratchgofy(this);
    }
}
