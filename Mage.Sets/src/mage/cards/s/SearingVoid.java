 ...
 * @author TheElk801
 */
public final class SearingVoid extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SearingVoid(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SearingVoid(final SearingVoid card) {
        super(card);
    }

    @Override
    public SearingVoid copy() {
        return new SearingVoid(this);
    }
}
