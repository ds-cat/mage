 ...
 * @author TheElk801
 */
public final class SeeingDouble extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SeeingDouble(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SeeingDouble(final SeeingDouble card) {
        super(card);
    }

    @Override
    public SeeingDouble copy() {
        return new SeeingDouble(this);
    }
}
