 ...
 * @author TheElk801
 */
public final class SelfDrivingNarrative extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SelfDrivingNarrative(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SelfDrivingNarrative(final SelfDrivingNarrative card) {
        super(card);
    }

    @Override
    public SelfDrivingNarrative copy() {
        return new SelfDrivingNarrative(this);
    }
}
