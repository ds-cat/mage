 ...
 * @author TheElk801
 */
public final class SentToTheAttic extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SentToTheAttic(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SentToTheAttic(final SentToTheAttic card) {
        super(card);
    }

    @Override
    public SentToTheAttic copy() {
        return new SentToTheAttic(this);
    }
}
