 ...
 * @author TheElk801
 */
public final class SentientOrb extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SentientOrb(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SentientOrb(final SentientOrb card) {
        super(card);
    }

    @Override
    public SentientOrb copy() {
        return new SentientOrb(this);
    }
}
