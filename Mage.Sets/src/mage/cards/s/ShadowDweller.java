 ...
 * @author TheElk801
 */
public final class ShadowDweller extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ShadowDweller(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ShadowDweller(final ShadowDweller card) {
        super(card);
    }

    @Override
    public ShadowDweller copy() {
        return new ShadowDweller(this);
    }
}
