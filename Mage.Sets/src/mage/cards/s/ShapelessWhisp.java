 ...
 * @author TheElk801
 */
public final class ShapelessWhisp extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ShapelessWhisp(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ShapelessWhisp(final ShapelessWhisp card) {
        super(card);
    }

    @Override
    public ShapelessWhisp copy() {
        return new ShapelessWhisp(this);
    }
}
