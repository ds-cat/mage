 ...
 * @author TheElk801
 */
public final class ShatteredMirrorStyle extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ShatteredMirrorStyle(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ShatteredMirrorStyle(final ShatteredMirrorStyle card) {
        super(card);
    }

    @Override
    public ShatteredMirrorStyle copy() {
        return new ShatteredMirrorStyle(this);
    }
}
