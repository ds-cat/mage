 ...
 * @author TheElk801
 */
public final class SidMisunderstoodArtist extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SidMisunderstoodArtist(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SidMisunderstoodArtist(final SidMisunderstoodArtist card) {
        super(card);
    }

    @Override
    public SidMisunderstoodArtist copy() {
        return new SidMisunderstoodArtist(this);
    }
}
