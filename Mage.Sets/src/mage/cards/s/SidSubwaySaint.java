 ...
 * @author TheElk801
 */
public final class SidSubwaySaint extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SidSubwaySaint(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SidSubwaySaint(final SidSubwaySaint card) {
        super(card);
    }

    @Override
    public SidSubwaySaint copy() {
        return new SidSubwaySaint(this);
    }
}
