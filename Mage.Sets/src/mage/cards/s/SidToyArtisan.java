 ...
 * @author TheElk801
 */
public final class SidToyArtisan extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SidToyArtisan(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SidToyArtisan(final SidToyArtisan card) {
        super(card);
    }

    @Override
    public SidToyArtisan copy() {
        return new SidToyArtisan(this);
    }
}
