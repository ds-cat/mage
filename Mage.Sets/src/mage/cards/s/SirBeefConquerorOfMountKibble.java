 ...
 * @author TheElk801
 */
public final class SirBeefConquerorOfMountKibble extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SirBeefConquerorOfMountKibble(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SirBeefConquerorOfMountKibble(final SirBeefConquerorOfMountKibble card) {
        super(card);
    }

    @Override
    public SirBeefConquerorOfMountKibble copy() {
        return new SirBeefConquerorOfMountKibble(this);
    }
}
