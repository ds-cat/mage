 ...
 * @author TheElk801
 */
public final class SlinkyDog extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SlinkyDog(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SlinkyDog(final SlinkyDog card) {
        super(card);
    }

    @Override
    public SlinkyDog copy() {
        return new SlinkyDog(this);
    }
}
