 ...
 * @author TheElk801
 */
public final class SlopCrusader extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SlopCrusader(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SlopCrusader(final SlopCrusader card) {
        super(card);
    }

    @Override
    public SlopCrusader copy() {
        return new SlopCrusader(this);
    }
}
