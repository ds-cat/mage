 ...
 * @author TheElk801
 */
public final class SlopGorgerWurm extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SlopGorgerWurm(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SlopGorgerWurm(final mage.cards.s.SlopGorgerWurm card) {
        super(card);
    }

    @Override
    public mage.cards.s.SlopGorgerWurm copy() {
        return new mage.cards.s.SlopGorgerWurm(this);
    }
}
