 ...
 * @author TheElk801
 */
public final class SlopMirror extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SlopMirror(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SlopMirror(final SlopMirror card) {
        super(card);
    }

    @Override
    public SlopMirror copy() {
        return new SlopMirror(this);
    }
}
