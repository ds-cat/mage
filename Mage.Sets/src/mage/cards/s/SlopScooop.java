 ...
 * @author TheElk801
 */
public final class SlopScooop extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SlopScooop(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SlopScooop(final SlopScooop card) {
        super(card);
    }

    @Override
    public SlopScooop copy() {
        return new SlopScooop(this);
    }
}
