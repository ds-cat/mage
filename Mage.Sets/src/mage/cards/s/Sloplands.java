 ...
 * @author TheElk801
 */
public final class Sloplands extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Sloplands(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Sloplands(final Sloplands card) {
        super(card);
    }

    @Override
    public Sloplands copy() {
        return new Sloplands(this);
    }
}
