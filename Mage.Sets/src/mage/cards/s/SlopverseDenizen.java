 ...
 * @author TheElk801
 */
public final class SlopverseDenizen extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SlopverseDenizen(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SlopverseDenizen(final SlopverseDenizen card) {
        super(card);
    }

    @Override
    public SlopverseDenizen copy() {
        return new SlopverseDenizen(this);
    }
}
