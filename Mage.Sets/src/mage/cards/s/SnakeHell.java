 ...
 * @author TheElk801
 */
public final class SnakeHell extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SnakeHell(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SnakeHell(final SnakeHell card) {
        super(card);
    }

    @Override
    public SnakeHell copy() {
        return new SnakeHell(this);
    }
}
