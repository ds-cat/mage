 ...
 * @author TheElk801
 */
public final class SnakeLordAssassin extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SnakeLordAssassin(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SnakeLordAssassin(final SnakeLordAssassin card) {
        super(card);
    }

    @Override
    public SnakeLordAssassin copy() {
        return new SnakeLordAssassin(this);
    }
}
