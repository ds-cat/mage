 ...
 * @author TheElk801
 */
public final class SnakeLordChampion extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SnakeLordChampion(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SnakeLordChampion(final SnakeLordChampion card) {
        super(card);
    }

    @Override
    public SnakeLordChampion copy() {
        return new SnakeLordChampion(this);
    }
}
