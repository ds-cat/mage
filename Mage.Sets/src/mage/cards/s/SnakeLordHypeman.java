 ...
 * @author TheElk801
 */
public final class SnakeLordHypeman extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SnakeLordHypeman(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SnakeLordHypeman(final SnakeLordHypeman card) {
        super(card);
    }

    @Override
    public SnakeLordHypeman copy() {
        return new SnakeLordHypeman(this);
    }
}
