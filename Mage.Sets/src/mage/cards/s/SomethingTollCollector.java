 ...
 * @author TheElk801
 */
public final class SomethingTollCollector extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SomethingTollCollector(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SomethingTollCollector(final SomethingTollCollector card) {
        super(card);
    }

    @Override
    public SomethingTollCollector copy() {
        return new SomethingTollCollector(this);
    }
}
