 ...
 * @author TheElk801
 */
public final class SootyTry extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SootyTry(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SootyTry(final SootyTry card) {
        super(card);
    }

    @Override
    public SootyTry copy() {
        return new SootyTry(this);
    }
}
