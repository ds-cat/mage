 ...
 * @author TheElk801
 */
public final class SorrowfulShadow extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SorrowfulShadow(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SorrowfulShadow(final SorrowfulShadow card) {
        super(card);
    }

    @Override
    public SorrowfulShadow copy() {
        return new SorrowfulShadow(this);
    }
}
