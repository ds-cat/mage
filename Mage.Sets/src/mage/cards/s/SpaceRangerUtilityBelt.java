 ...
 * @author TheElk801
 */
public final class SpaceRangerUtilityBelt extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpaceRangerUtilityBelt(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpaceRangerUtilityBelt(final SpaceRangerUtilityBelt card) {
        super(card);
    }

    @Override
    public SpaceRangerUtilityBelt copy() {
        return new SpaceRangerUtilityBelt(this);
    }
}
