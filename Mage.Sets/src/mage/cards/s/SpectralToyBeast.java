 ...
 * @author TheElk801
 */
public final class SpectralToyBeast extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpectralToyBeast(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpectralToyBeast(final SpectralToyBeast card) {
        super(card);
    }

    @Override
    public SpectralToyBeast copy() {
        return new SpectralToyBeast(this);
    }
}
