 ...
 * @author TheElk801
 */
public final class SpeechPodium extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpeechPodium(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpeechPodium(final SpeechPodium card) {
        super(card);
    }

    @Override
    public SpeechPodium copy() {
        return new SpeechPodium(this);
    }
}
