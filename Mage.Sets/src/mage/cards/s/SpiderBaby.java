 ...
 * @author TheElk801
 */
public final class SpiderBaby extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpiderBaby(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpiderBaby(final SpiderBaby card) {
        super(card);
    }

    @Override
    public SpiderBaby copy() {
        return new SpiderBaby(this);
    }
}
