 ...
 * @author TheElk801
 */
public final class SpiritHuntingDoll extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpiritHuntingDoll(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpiritHuntingDoll(final SpiritHuntingDoll card) {
        super(card);
    }

    @Override
    public SpiritHuntingDoll copy() {
        return new SpiritHuntingDoll(this);
    }
}
