 ...
 * @author TheElk801
 */
public final class SpiritOfChoice extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpiritOfChoice(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpiritOfChoice(final SpiritOfChoice card) {
        super(card);
    }

    @Override
    public SpiritOfChoice copy() {
        return new SpiritOfChoice(this);
    }
}
