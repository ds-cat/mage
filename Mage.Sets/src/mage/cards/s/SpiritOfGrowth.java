 ...
 * @author TheElk801
 */
public final class SpiritOfGrowth extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpiritOfGrowth(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpiritOfGrowth(final SpiritOfGrowth card) {
        super(card);
    }

    @Override
    public SpiritOfGrowth copy() {
        return new SpiritOfGrowth(this);
    }
}
