 ...
 * @author TheElk801
 */
public final class SpiritOfNostagia extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpiritOfNostagia(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpiritOfNostagia(final SpiritOfNostagia card) {
        super(card);
    }

    @Override
    public SpiritOfNostagia copy() {
        return new SpiritOfNostagia(this);
    }
}
