 ...
 * @author TheElk801
 */
public final class SpitfireKatana extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpitfireKatana(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpitfireKatana(final SpitfireKatana card) {
        super(card);
    }

    @Override
    public SpitfireKatana copy() {
        return new SpitfireKatana(this);
    }
}
