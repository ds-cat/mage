 ...
 * @author TheElk801
 */
public final class SpreadingScratches extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SpreadingScratches(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SpreadingScratches(final SpreadingScratches card) {
        super(card);
    }

    @Override
    public SpreadingScratches copy() {
        return new SpreadingScratches(this);
    }
}
