 ...
 * @author TheElk801
 */
public final class StallingForTime extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public StallingForTime(UUID ownerId, CardSetInfo setInfo) {
    ...
    private StallingForTime(final StallingForTime card) {
        super(card);
    }

    @Override
    public StallingForTime copy() {
        return new StallingForTime(this);
    }
}
