 ...
 * @author TheElk801
 */
public final class StinkyPete extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public StinkyPete(UUID ownerId, CardSetInfo setInfo) {
    ...
    private StinkyPete(final StinkyPete card) {
        super(card);
    }

    @Override
    public StinkyPete copy() {
        return new StinkyPete(this);
    }
}
