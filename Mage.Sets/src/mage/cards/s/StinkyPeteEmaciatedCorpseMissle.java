 ...
 * @author TheElk801
 */
public final class StinkyPeteEmaciatedCorpseMissle extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public StinkyPeteEmaciatedCorpseMissle(UUID ownerId, CardSetInfo setInfo) {
    ...
    private StinkyPeteEmaciatedCorpseMissle(final StinkyPeteEmaciatedCorpseMissle card) {
        super(card);
    }

    @Override
    public StinkyPeteEmaciatedCorpseMissle copy() {
        return new StinkyPeteEmaciatedCorpseMissle(this);
    }
}
