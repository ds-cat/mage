 ...
 * @author TheElk801
 */
public final class SubcounsciousDefender extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SubcounsciousDefender(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SubcounsciousDefender(final SubcounsciousDefender card) {
        super(card);
    }

    @Override
    public SubcounsciousDefender copy() {
        return new SubcounsciousDefender(this);
    }
}
