 ...
 * @author TheElk801
 */
public final class SubspaceSubway extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SubspaceSubway(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SubspaceSubway(final SubspaceSubway card) {
        super(card);
    }

    @Override
    public SubspaceSubway copy() {
        return new SubspaceSubway(this);
    }
}
