 ...
 * @author TheElk801
 */
public final class Suburbia extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public Suburbia(UUID ownerId, CardSetInfo setInfo) {
    ...
    private Suburbia(final Suburbia card) {
        super(card);
    }

    @Override
    public Suburbia copy() {
        return new Suburbia(this);
    }
}
