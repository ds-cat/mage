 ...
 * @author TheElk801
 */
public final class SubwaySlopper extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SubwaySlopper(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SubwaySlopper(final SubwaySlopper card) {
        super(card);
    }

    @Override
    public SubwaySlopper copy() {
        return new SubwaySlopper(this);
    }
}
