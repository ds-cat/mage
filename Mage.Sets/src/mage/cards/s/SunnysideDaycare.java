 ...
 * @author TheElk801
 */
public final class SunnysideDaycare extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SunnysideDaycare(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SunnysideDaycare(final SunnysideDaycare card) {
        super(card);
    }

    @Override
    public SunnysideDaycare copy() {
        return new SunnysideDaycare(this);
    }
}
