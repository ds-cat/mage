 ...
 * @author TheElk801
 */
public final class SuperegoDweller extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SuperegoDweller(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SuperegoDweller(final SuperegoDweller card) {
        super(card);
    }

    @Override
    public SuperegoDweller copy() {
        return new SuperegoDweller(this);
    }
}
