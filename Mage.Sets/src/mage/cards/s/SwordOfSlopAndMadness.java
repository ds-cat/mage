 ...
 * @author TheElk801
 */
public final class SwordOfSlopAndMadness extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public SwordOfSlopAndMadness(UUID ownerId, CardSetInfo setInfo) {
    ...
    private SwordOfSlopAndMadness(final SwordOfSlopAndMadness card) {
        super(card);
    }

    @Override
    public SwordOfSlopAndMadness copy() {
        return new SwordOfSlopAndMadness(this);
    }
}
