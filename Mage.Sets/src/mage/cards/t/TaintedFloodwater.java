 ...
 * @author TheElk801
 */
public final class TaintedFloodwater extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TaintedFloodwater(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TaintedFloodwater(final TaintedFloodwater card) {
        super(card);
    }

    @Override
    public TaintedFloodwater copy() {
        return new TaintedFloodwater(this);
    }
}
