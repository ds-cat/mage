 ...
 * @author TheElk801
 */
public final class TearingThroughLayers extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TearingThroughLayers(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TearingThroughLayers(final TearingThroughLayers card) {
        super(card);
    }

    @Override
    public TearingThroughLayers copy() {
        return new TearingThroughLayers(this);
    }
}
