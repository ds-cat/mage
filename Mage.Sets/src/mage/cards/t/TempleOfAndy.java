 ...
 * @author TheElk801
 */
public final class TempleOfAndy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TempleOfAndy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TempleOfAndy(final TempleOfAndy card) {
        super(card);
    }

    @Override
    public TempleOfAndy copy() {
        return new TempleOfAndy(this);
    }
}
