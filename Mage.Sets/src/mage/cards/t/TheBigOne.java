 ...
 * @author TheElk801
 */
public final class TheBigOne extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheBigOne(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheBigOne(final TheBigOne card) {
        super(card);
    }

    @Override
    public TheBigOne copy() {
        return new TheBigOne(this);
    }
}
