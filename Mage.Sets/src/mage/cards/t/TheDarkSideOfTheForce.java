 ...
 * @author TheElk801
 */
public final class TheDarkSideOfTheForce extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheDarkSideOfTheForce(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheDarkSideOfTheForce(final TheDarkSideOfTheForce card) {
        super(card);
    }

    @Override
    public TheDarkSideOfTheForce copy() {
        return new TheDarkSideOfTheForce(this);
    }
}
