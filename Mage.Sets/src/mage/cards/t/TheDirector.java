 ...
 * @author TheElk801
 */
public final class TheDirector extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheDirector(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheDirector(final TheDirector card) {
        super(card);
    }

    @Override
    public TheDirector copy() {
        return new TheDirector(this);
    }
}
