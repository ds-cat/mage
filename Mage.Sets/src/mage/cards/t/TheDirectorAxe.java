 ...
 * @author TheElk801
 */
public final class TheDirectorAxe extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheDirectorAxe(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheDirectorAxe(final TheDirectorAxe card) {
        super(card);
    }

    @Override
    public TheDirectorAxe copy() {
        return new TheDirectorAxe(this);
    }
}
