 ...
 * @author TheElk801
 */
public final class TheForest extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheForest(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheForest(final TheForest card) {
        super(card);
    }

    @Override
    public TheForest copy() {
        return new TheForest(this);
    }
}
