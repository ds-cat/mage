 ...
 * @author TheElk801
 */
public final class TheHappyCanteen extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheHappyCanteen(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheHappyCanteen(final TheHappyCanteen card) {
        super(card);
    }

    @Override
    public TheHappyCanteen copy() {
        return new TheHappyCanteen(this);
    }
}
