 ...
 * @author TheElk801
 */
public final class TheLightSideOfTheForce extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheLightSideOfTheForce(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheLightSideOfTheForce(final TheLightSideOfTheForce card) {
        super(card);
    }

    @Override
    public TheLightSideOfTheForce copy() {
        return new TheLightSideOfTheForce(this);
    }
}
