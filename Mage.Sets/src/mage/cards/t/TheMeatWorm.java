 ...
 * @author TheElk801
 */
public final class TheMeatWorm extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheMeatWorm(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheMeatWorm(final TheMeatWorm card) {
        super(card);
    }

    @Override
    public TheMeatWorm copy() {
        return new TheMeatWorm(this);
    }
}
