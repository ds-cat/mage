 ...
 * @author TheElk801
 */
public final class ThePhoneFromToyStoryThree extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ThePhoneFromToyStoryThree(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ThePhoneFromToyStoryThree(final ThePhoneFromToyStoryThree card) {
        super(card);
    }

    @Override
    public ThePhoneFromToyStoryThree copy() {
        return new ThePhoneFromToyStoryThree(this);
    }
}
