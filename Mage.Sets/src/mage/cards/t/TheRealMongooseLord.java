 ...
 * @author TheElk801
 */
public final class TheRealMongooseLord extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheRealMongooseLord(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheRealMongooseLord(final TheRealMongooseLord card) {
        super(card);
    }

    @Override
    public TheRealMongooseLord copy() {
        return new TheRealMongooseLord(this);
    }
}
