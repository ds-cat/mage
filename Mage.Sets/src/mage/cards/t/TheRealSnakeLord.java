 ...
 * @author TheElk801
 */
public final class TheRealSnakeLord extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheRealSnakeLord(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheRealSnakeLord(final TheRealSnakeLord card) {
        super(card);
    }

    @Override
    public TheRealSnakeLord copy() {
        return new TheRealSnakeLord(this);
    }
}
