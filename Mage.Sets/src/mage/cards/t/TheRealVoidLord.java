 ...
 * @author TheElk801
 */
public final class TheRealVoidLord extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheRealVoidLord(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheRealVoidLord(final TheRealVoidLord card) {
        super(card);
    }

    @Override
    public TheRealVoidLord copy() {
        return new TheRealVoidLord(this);
    }
}
