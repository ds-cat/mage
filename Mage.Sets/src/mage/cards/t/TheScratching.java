 ...
 * @author TheElk801
 */
public final class TheScratching extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheScratching(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheScratching(final TheScratching card) {
        super(card);
    }

    @Override
    public TheScratching copy() {
        return new TheScratching(this);
    }
}
