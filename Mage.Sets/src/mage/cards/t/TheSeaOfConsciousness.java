 ...
 * @author TheElk801
 */
public final class TheSeaOfConsciousness extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheSeaOfConsciousness(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheSeaOfConsciousness(final TheSeaOfConsciousness card) {
        super(card);
    }

    @Override
    public TheSeaOfConsciousness copy() {
        return new TheSeaOfConsciousness(this);
    }
}
