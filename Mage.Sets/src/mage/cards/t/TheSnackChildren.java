 ...
 * @author TheElk801
 */
public final class TheSnackChildren extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheSnackChildren(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheSnackChildren(final TheSnackChildren card) {
        super(card);
    }

    @Override
    public TheSnackChildren copy() {
        return new TheSnackChildren(this);
    }
}
