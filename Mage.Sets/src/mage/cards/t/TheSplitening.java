 ...
 * @author TheElk801
 */
public final class TheSplitening extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheSplitening(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheSplitening(final TheSplitening card) {
        super(card);
    }

    @Override
    public TheSplitening copy() {
        return new TheSplitening(this);
    }
}
