 ...
 * @author TheElk801
 */
public final class TheStinkwalker extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheStinkwalker(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheStinkwalker(final TheStinkwalker card) {
        super(card);
    }

    @Override
    public TheStinkwalker copy() {
        return new TheStinkwalker(this);
    }
}
