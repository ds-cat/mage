 ...
 * @author TheElk801
 */
public final class TheTripleing extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheTripleing(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheTripleing(final TheTripleing card) {
        super(card);
    }

    @Override
    public TheTripleing copy() {
        return new TheTripleing(this);
    }
}
