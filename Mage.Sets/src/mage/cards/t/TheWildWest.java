 ...
 * @author TheElk801
 */
public final class TheWildWest extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheWildWest(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheWildWest(final TheWildWest card) {
        super(card);
    }

    @Override
    public TheWildWest copy() {
        return new TheWildWest(this);
    }
}
