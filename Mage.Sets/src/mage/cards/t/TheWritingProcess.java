 ...
 * @author TheElk801
 */
public final class TheWritingProcess extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TheWritingProcess(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TheWritingProcess(final TheWritingProcess card) {
        super(card);
    }

    @Override
    public TheWritingProcess copy() {
        return new TheWritingProcess(this);
    }
}
