 ...
 * @author TheElk801
 */
public final class ThirstForPurpose extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ThirstForPurpose(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ThirstForPurpose(final ThirstForPurpose card) {
        super(card);
    }

    @Override
    public ThirstForPurpose copy() {
        return new ThirstForPurpose(this);
    }
}
