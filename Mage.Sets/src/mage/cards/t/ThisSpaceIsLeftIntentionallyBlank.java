 ...
 * @author TheElk801
 */
public final class ThisSpaceIsLeftIntentionallyBlank extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ThisSpaceIsLeftIntentionallyBlank(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ThisSpaceIsLeftIntentionallyBlank(final ThisSpaceIsLeftIntentionallyBlank card) {
        super(card);
    }

    @Override
    public ThisSpaceIsLeftIntentionallyBlank copy() {
        return new ThisSpaceIsLeftIntentionallyBlank(this);
    }
}
