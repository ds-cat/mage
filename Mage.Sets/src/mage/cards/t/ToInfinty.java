 ...
 * @author TheElk801
 */
public final class ToInfinty extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToInfinty(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToInfinty(final ToInfinty card) {
        super(card);
    }

    @Override
    public ToInfinty copy() {
        return new ToInfinty(this);
    }
}
