 ...
 * @author TheElk801
 */
public final class ToonClass extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToonClass(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToonClass(final ToonClass card) {
        super(card);
    }

    @Override
    public ToonClass copy() {
        return new ToonClass(this);
    }
}
