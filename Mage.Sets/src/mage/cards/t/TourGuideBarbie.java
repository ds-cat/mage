 ...
 * @author TheElk801
 */
public final class TourGuideBarbie extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TourGuideBarbie(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TourGuideBarbie(final TourGuideBarbie card) {
        super(card);
    }

    @Override
    public TourGuideBarbie copy() {
        return new TourGuideBarbie(this);
    }
}
