 ...
 * @author TheElk801
 */
public final class ToyDrone extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToyDrone(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToyDrone(final ToyDrone card) {
        super(card);
    }

    @Override
    public ToyDrone copy() {
        return new ToyDrone(this);
    }
}
