 ...
 * @author TheElk801
 */
public final class ToyDungeonCadaver extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToyDungeonCadaver(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToyDungeonCadaver(final ToyDungeonCadaver card) {
        super(card);
    }

    @Override
    public ToyDungeonCadaver copy() {
        return new ToyDungeonCadaver(this);
    }
}
