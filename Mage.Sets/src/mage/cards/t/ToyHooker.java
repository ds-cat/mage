 ...
 * @author TheElk801
 */
public final class ToyHooker extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToyHooker(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToyHooker(final ToyHooker card) {
        super(card);
    }

    @Override
    public ToyHooker copy() {
        return new ToyHooker(this);
    }
}
