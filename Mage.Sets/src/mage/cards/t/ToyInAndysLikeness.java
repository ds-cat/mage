 ...
 * @author TheElk801
 */
public final class ToyInAndysLikeness extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToyInAndysLikeness(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToyInAndysLikeness(final ToyInAndysLikeness card) {
        super(card);
    }

    @Override
    public ToyInAndysLikeness copy() {
        return new ToyInAndysLikeness(this);
    }
}
