 ...
 * @author TheElk801
 */
public final class ToyRepairStation extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToyRepairStation(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToyRepairStation(final ToyRepairStation card) {
        super(card);
    }

    @Override
    public ToyRepairStation copy() {
        return new ToyRepairStation(this);
    }
}
