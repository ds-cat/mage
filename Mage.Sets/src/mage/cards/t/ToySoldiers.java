 ...
 * @author TheElk801
 */
public final class ToySoldiers extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToySoldiers(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToySoldiers(final ToySoldiers card) {
        super(card);
    }

    @Override
    public ToySoldiers copy() {
        return new ToySoldiers(this);
    }
}
