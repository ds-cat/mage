 ...
 * @author TheElk801
 */
public final class ToyStoryTrilogy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToyStoryTrilogy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToyStoryTrilogy(final ToyStoryTrilogy card) {
        super(card);
    }

    @Override
    public ToyStoryTrilogy copy() {
        return new ToyStoryTrilogy(this);
    }
}
