 ...
 * @author TheElk801
 */
public final class ToySword extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToySword(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToySword(final ToySword card) {
        super(card);
    }

    @Override
    public ToySword copy() {
        return new ToySword(this);
    }
}
