 ...
 * @author TheElk801
 */
public final class ToyTinkerer extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ToyTinkerer(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ToyTinkerer(final ToyTinkerer card) {
        super(card);
    }

    @Override
    public ToyTinkerer copy() {
        return new ToyTinkerer(this);
    }
}
