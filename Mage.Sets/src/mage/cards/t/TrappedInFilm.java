 ...
 * @author TheElk801
 */
public final class TrappedInFilm extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TrappedInFilm(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TrappedInFilm(final TrappedInFilm card) {
        super(card);
    }

    @Override
    public TrappedInFilm copy() {
        return new TrappedInFilm(this);
    }
}
