 ...
 * @author TheElk801
 */
public final class TrashToy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TrashToy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TrashToy(final TrashToy card) {
        super(card);
    }

    @Override
    public TrashToy copy() {
        return new TrashToy(this);
    }
}
