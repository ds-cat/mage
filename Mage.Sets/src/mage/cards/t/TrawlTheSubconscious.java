 ...
 * @author TheElk801
 */
public final class TrawlTheSubconscious extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public TrawlTheSubconscious(UUID ownerId, CardSetInfo setInfo) {
    ...
    private TrawlTheSubconscious(final TrawlTheSubconscious card) {
        super(card);
    }

    @Override
    public TrawlTheSubconscious copy() {
        return new TrawlTheSubconscious(this);
    }
}
