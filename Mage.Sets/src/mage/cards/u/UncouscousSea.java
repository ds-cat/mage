 ...
 * @author TheElk801
 */
public final class UncouscousSea extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public UncouscousSea(UUID ownerId, CardSetInfo setInfo) {
    ...
    private UncouscousSea(final UncouscousSea card) {
        super(card);
    }

    @Override
    public UncouscousSea copy() {
        return new UncouscousSea(this);
    }
}
