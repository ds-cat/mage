 ...
 * @author TheElk801
 */
public final class UnformedAbomination extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public UnformedAbomination(UUID ownerId, CardSetInfo setInfo) {
    ...
    private UnformedAbomination(final UnformedAbomination card) {
        super(card);
    }

    @Override
    public UnformedAbomination copy() {
        return new UnformedAbomination(this);
    }
}
