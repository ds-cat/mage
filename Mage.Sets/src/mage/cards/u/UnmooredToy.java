 ...
 * @author TheElk801
 */
public final class UnmooredToy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public UnmooredToy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private UnmooredToy(final UnmooredToy card) {
        super(card);
    }

    @Override
    public UnmooredToy copy() {
        return new UnmooredToy(this);
    }
}
