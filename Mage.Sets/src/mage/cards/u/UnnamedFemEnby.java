 ...
 * @author TheElk801
 */
public final class UnnamedFemEnby extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public UnnamedFemEnby(UUID ownerId, CardSetInfo setInfo) {
    ...
    private UnnamedFemEnby(final UnnamedFemEnby card) {
        super(card);
    }

    @Override
    public UnnamedFemEnby copy() {
        return new UnnamedFemEnby(this);
    }
}
