 ...
 * @author TheElk801
 */
public final class UnnessarySideCharacter extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public UnnessarySideCharacter(UUID ownerId, CardSetInfo setInfo) {
    ...
    private UnnessarySideCharacter(final UnnessarySideCharacter card) {
        super(card);
    }

    @Override
    public UnnessarySideCharacter copy() {
        return new UnnessarySideCharacter(this);
    }
}
