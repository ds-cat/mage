 ...
 * @author TheElk801
 */
public final class VacuousFiller extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public VacuousFiller(UUID ownerId, CardSetInfo setInfo) {
    ...
    private VacuousFiller(final VacuousFiller card) {
        super(card);
    }

    @Override
    public VacuousFiller copy() {
        return new VacuousFiller(this);
    }
}
