 ...
 * @author TheElk801
 */
public final class VentureToAndy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public VentureToAndy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private VentureToAndy(final VentureToAndy card) {
        super(card);
    }

    @Override
    public VentureToAndy copy() {
        return new VentureToAndy(this);
    }
}
