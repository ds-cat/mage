 ...
 * @author TheElk801
 */
public final class VisionsOfTheAbyss extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public VisionsOfTheAbyss(UUID ownerId, CardSetInfo setInfo) {
    ...
    private VisionsOfTheAbyss(final VisionsOfTheAbyss card) {
        super(card);
    }

    @Override
    public VisionsOfTheAbyss copy() {
        return new VisionsOfTheAbyss(this);
    }
}
