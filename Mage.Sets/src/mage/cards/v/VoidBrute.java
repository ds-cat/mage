 ...
 * @author TheElk801
 */
public final class VoidBrute extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public VoidBrute(UUID ownerId, CardSetInfo setInfo) {
    ...
    private VoidBrute(final VoidBrute card) {
        super(card);
    }

    @Override
    public VoidBrute copy() {
        return new VoidBrute(this);
    }
}
