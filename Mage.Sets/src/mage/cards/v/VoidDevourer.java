 ...
 * @author TheElk801
 */
public final class VoidDevourer extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public VoidDevourer(UUID ownerId, CardSetInfo setInfo) {
    ...
    private VoidDevourer(final VoidDevourer card) {
        super(card);
    }

    @Override
    public VoidDevourer copy() {
        return new VoidDevourer(this);
    }
}
