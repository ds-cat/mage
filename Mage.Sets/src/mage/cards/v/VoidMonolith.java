 ...
 * @author TheElk801
 */
public final class VoidMonolith extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public VoidMonolith(UUID ownerId, CardSetInfo setInfo) {
    ...
    private VoidMonolith(final VoidMonolith card) {
        super(card);
    }

    @Override
    public VoidMonolith copy() {
        return new VoidMonolith(this);
    }
}
