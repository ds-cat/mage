 ...
 * @author TheElk801
 */
public final class VolcanicPeniunsula extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public VolcanicPeniunsula(UUID ownerId, CardSetInfo setInfo) {
    ...
    private VolcanicPeniunsula(final VolcanicPeniunsula card) {
        super(card);
    }

    @Override
    public VolcanicPeniunsula copy() {
        return new VolcanicPeniunsula(this);
    }
}
