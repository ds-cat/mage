 ...
 * @author TheElk801
 */
public final class WallOfIdeas extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WallOfIdeas(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WallOfIdeas(final WallOfIdeas card) {
        super(card);
    }

    @Override
    public WallOfIdeas copy() {
        return new WallOfIdeas(this);
    }
}
