 ...
 * @author TheElk801
 */
public final class WanderingNarrator extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WanderingNarrator(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WanderingNarrator(final WanderingNarrator card) {
        super(card);
    }

    @Override
    public WanderingNarrator copy() {
        return new WanderingNarrator(this);
    }
}
