 ...
 * @author TheElk801
 */
public final class WarpedGlassStrike extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WarpedGlassStrike(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WarpedGlassStrike(final WarpedGlassStrike card) {
        super(card);
    }

    @Override
    public WarpedGlassStrike copy() {
        return new WarpedGlassStrike(this);
    }
}
