 ...
 * @author TheElk801
 */
public final class WesterStyleRepeater extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WesterStyleRepeater(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WesterStyleRepeater(final WesterStyleRepeater card) {
        super(card);
    }

    @Override
    public WesterStyleRepeater copy() {
        return new WesterStyleRepeater(this);
    }
}
