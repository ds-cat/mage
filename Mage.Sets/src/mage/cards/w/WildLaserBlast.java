 ...
 * @author TheElk801
 */
public final class WildLaserBlast extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WildLaserBlast(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WildLaserBlast(final WildLaserBlast card) {
        super(card);
    }

    @Override
    public WildLaserBlast copy() {
        return new WildLaserBlast(this);
    }
}
