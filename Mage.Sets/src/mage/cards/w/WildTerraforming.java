 ...
 * @author TheElk801
 */
public final class WildTerraforming extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WildTerraforming(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WildTerraforming(final WildTerraforming card) {
        super(card);
    }

    @Override
    public WildTerraforming copy() {
        return new WildTerraforming(this);
    }
}
