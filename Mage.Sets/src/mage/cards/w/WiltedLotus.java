 ...
 * @author TheElk801
 */
public final class WiltedLotus extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WiltedLotus(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WiltedLotus(final WiltedLotus card) {
        super(card);
    }

    @Override
    public WiltedLotus copy() {
        return new WiltedLotus(this);
    }
}
