 ...
 * @author TheElk801
 */
public final class WingedSnake extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WingedSnake(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WingedSnake(final WingedSnake card) {
        super(card);
    }

    @Override
    public WingedSnake copy() {
        return new WingedSnake(this);
    }
}
