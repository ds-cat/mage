 ...
 * @author TheElk801
 */
public final class WoodyIntellectual extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WoodyIntellectual(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WoodyIntellectual(final WoodyIntellectual card) {
        super(card);
    }

    @Override
    public WoodyIntellectual copy() {
        return new WoodyIntellectual(this);
    }
}
