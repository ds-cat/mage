 ...
 * @author TheElk801
 */
public final class WoodyMindMaster extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WoodyMindMaster(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WoodyMindMaster(final WoodyMindMaster card) {
        super(card);
    }

    @Override
    public WoodyMindMaster copy() {
        return new WoodyMindMaster(this);
    }
}
