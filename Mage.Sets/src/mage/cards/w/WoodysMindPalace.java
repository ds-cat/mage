 ...
 * @author TheElk801
 */
public final class WoodysMindPalace extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WoodysMindPalace(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WoodysMindPalace(final WoodysMindPalace card) {
        super(card);
    }

    @Override
    public WoodysMindPalace copy() {
        return new WoodysMindPalace(this);
    }
}
