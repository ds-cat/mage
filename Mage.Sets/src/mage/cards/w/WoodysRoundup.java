 ...
 * @author TheElk801
 */
public final class WoodysRoundup extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WoodysRoundup(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WoodysRoundup(final WoodysRoundup card) {
        super(card);
    }

    @Override
    public WoodysRoundup copy() {
        return new WoodysRoundup(this);
    }
}
