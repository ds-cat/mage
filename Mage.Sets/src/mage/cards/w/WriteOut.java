 ...
 * @author TheElk801
 */
public final class WriteOut extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WriteOut(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WriteOut(final WriteOut card) {
        super(card);
    }

    @Override
    public WriteOut copy() {
        return new WriteOut(this);
    }
}
