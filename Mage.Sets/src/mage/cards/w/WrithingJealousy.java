 ...
 * @author TheElk801
 */
public final class WrithingJealousy extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public WrithingJealousy(UUID ownerId, CardSetInfo setInfo) {
    ...
    private WrithingJealousy(final WrithingJealousy card) {
        super(card);
    }

    @Override
    public WrithingJealousy copy() {
        return new WrithingJealousy(this);
    }
}
