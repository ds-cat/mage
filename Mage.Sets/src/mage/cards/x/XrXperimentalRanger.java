 ...
 * @author TheElk801
 */
public final class XrXperimentalRanger extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public XrXperimentalRanger(UUID ownerId, CardSetInfo setInfo) {
    ...
    private XrXperimentalRanger(final XrXperimentalRanger card) {
        super(card);
    }

    @Override
    public XrXperimentalRanger copy() {
        return new XrXperimentalRanger(this);
    }
}
