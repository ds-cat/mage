 ...
 * @author TheElk801
 */
public final class YoungStinkyPete extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public YoungStinkyPete(UUID ownerId, CardSetInfo setInfo) {
    ...
    private YoungStinkyPete(final YoungStinkyPete card) {
        super(card);
    }

    @Override
    public YoungStinkyPete copy() {
        return new YoungStinkyPete(this);
    }
}
