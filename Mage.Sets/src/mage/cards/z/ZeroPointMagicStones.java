 ...
 * @author TheElk801
 */
public final class ZeroPointMagicStones extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ZeroPointMagicStones(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ZeroPointMagicStones(final ZeroPointMagicStones card) {
        super(card);
    }

    @Override
    public ZeroPointMagicStones copy() {
        return new ZeroPointMagicStones(this);
    }
}
