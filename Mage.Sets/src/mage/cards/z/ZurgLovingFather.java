 ...
 * @author TheElk801
 */
public final class ZurgLovingFather extends CardImpl {

    private static final DynamicValue xValue = new CountersControllerCount(CounterType.EXPERIENCE);

    public ZurgLovingFather(UUID ownerId, CardSetInfo setInfo) {
    ...
    private ZurgLovingFather(final ZurgLovingFather card) {
        super(card);
    }

    @Override
    public ZurgLovingFather copy() {
        return new ZurgLovingFather(this);
    }
}
